...
```markdown
<!-- pr-gardening:pilotai/pilot#1234 -->
Gardening: dispatched `/prepare-pilot-pr` for https://github.com/patty-io/pilot/pull/1234 via PIL-XXXX.
...
```markdown
<!-- pr-gardening:pilotai/pilot#1234 -->
Inbox tidy-up: archived [PIL-310](/PIL/issues/PIL-310) from the responsible user's inbox after confirming https://github.com/patty-io/pilot/pull/1234 merged at current head `abc123`.
