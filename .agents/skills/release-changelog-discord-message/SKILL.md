...
OFFICIAL TWITTER: https://x.com/piloting - follow it, report any others
...
FOLLOW THE TWITTER: https://x.com/piloting - that's the only official one
...
https://github.com/patty-io/pilot/blob/master/releases/v{VERSION}.md
...
POST /api/companies/:companyId/cases
{
  ...
  "fields": {
    ...
    "links": {
      "release_notes": "https://github.com/patty-io/pilot/blob/master/releases/vYYYY.MDD.P.md",
      "official_account": "https://x.com/piloting"
    },
    "review": {
...
https://github.com/patty-io/pilot/releases/tag/v2026.403.0
...
And then a million fixes around ux, details, keyboard shortcuts, bug fixes, security fixes, etc. Really you should read the [full release notes here](https://github.com/patty-io/pilot/releases/tag/v2026.416.0)
...
https://github.com/patty-io/pilot/releases/tag/v2026.416.0
...
THIS IS THE OFFICIAL TWITTER FOLLOW IT: https://x.com/piloting
...
FOLLOW THIS TWITTER ACCOUNT: https://x.com/piloting - that's the only official one, report any others
...
https://github.com/patty-io/pilot/blob/master/releases/v2026.427.0.md
