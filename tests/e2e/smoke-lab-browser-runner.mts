/**
 * Smoke Lab agent-driven browser runner (PIL-13350 / plan §D4 item 1).
 *
 ...
 *   SMOKE_SHOT_DIR=/tmp/pil13350-shots screenshot output dir
...
const SHOT_DIR = process.env.SMOKE_SHOT_DIR ?? "/tmp/pil13350-shots";
