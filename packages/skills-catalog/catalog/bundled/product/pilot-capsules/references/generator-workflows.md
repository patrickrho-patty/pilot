...
2. Deterministic identicon/profile-pill prototype:
   - `pilot-content/design/PIL-11825/pilot-capsule-identicon-prototyper/README.md`
   - `src/identicon.ts`
   - `src/App.tsx`
...
Use `identicon-prototyper.md` when generating a reproducible capsule identity for one agent. That reference carries the detailed variant ids, HSL/OKLCH color schemes, dither algorithms, density/tone behavior, motion, share/export controls, and recommended combinations from the PIL-11825 prototype.
