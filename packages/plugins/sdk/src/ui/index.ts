/**
 * `@pilotai/plugin-sdk/ui` — Pilot plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@pilotai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@pilotai/plugin-sdk/ui";
 *
