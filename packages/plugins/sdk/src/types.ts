 ...
 * from `@pilotai/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @pilotai/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
...
export interface PluginLocalFoldersClient {
  ...
  declarations(): import("@pilotai/shared").PluginLocalFolderDeclaration[];
 ...
 * ```
 *
 * @see usePluginStream in `@pilotai/plugin-sdk/ui`
 */
