import type { PluginLauncherRegistration } from "@pilotai/plugin-sdk";

export const PLUGIN_ID = "pilot-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".pilot-kitchen-sink-demo.txt",
} as const;
