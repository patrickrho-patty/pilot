...
const manifest: PilotPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Pilot plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Pilot",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Pilot domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
