...
const PLUGIN_ID = "pilot.fake-sandbox-provider";
...
const manifest: PilotPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Pilot provider-plugin integration without external infrastructure.",
  author: "Pilot",
