...
import { copyTextToClipboard, usePluginData, usePluginToast } from "@pilotai/plugin-sdk/ui";
...
const FILE_SIDEBAR_WIDTH_STORAGE_KEY = "pilot.workspace-diff.files-sidebar-width";
