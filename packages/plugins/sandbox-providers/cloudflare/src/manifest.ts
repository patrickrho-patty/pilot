...
const PLUGIN_ID = "pilot.cloudflare-sandbox-provider";
  ...
  environmentDrivers: [
    {
      ...
      description:
        "Runs Pilot sandbox environments through a Cloudflare Worker bridge backed by the Sandbox SDK and Durable Objects.",
      configSchema: {
        type: "object",
        properties: {
          bridgeBaseUrl: {
