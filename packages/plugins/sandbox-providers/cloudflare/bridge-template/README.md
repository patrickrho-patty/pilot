...
It exposes a small authenticated JSON API under `/api/paperclip-sandbox/v1` and translates Pilot lease and command requests into Cloudflare Sandbox SDK calls.
