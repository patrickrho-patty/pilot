...
const SERVICE_ACCOUNT_NAME = "pilot-tenant-sa";
const ROLE_NAME = "pilot-tenant-role";
const ROLE_BINDING_NAME = "pilot-tenant-rb";
const RESOURCE_QUOTA_NAME = "pilot-quota";
const LIMIT_RANGE_NAME = "pilot-limits";
...
async function ensureNetworkPolicies(clients: KubeClients, input: EnsureTenantInput): Promise<void> {
  const [denyAll, egressStd] = buildNetworkPolicyManifests({
    namespace: input.namespace,
    pilotServerNamespace: input.pilotServerNamespace,
