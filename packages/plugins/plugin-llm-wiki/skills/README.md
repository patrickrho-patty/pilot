...
| [`pilot-distill`](./pilot-distill/SKILL.md) | Cursor-window, distill, or backfill operation on Pilot activity — write a wiki-insightful project page, decisions log, and history note. |
