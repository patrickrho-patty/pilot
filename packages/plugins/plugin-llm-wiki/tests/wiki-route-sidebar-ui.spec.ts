...
const EXPANDED_STORAGE_KEY = `pilotai.plugin-llm-wiki:route-sidebar-expanded:v2:${COMPANY_ID}`;
...
describe("WikiRouteSidebar", () => {
  ...
  beforeEach(() => {
    ...
    hostLocation = {
      pathname: "/PIL/wiki/page/wiki/concepts/sidebar-navigation.md",
      search: "",
      hash: "",
    };
    navigatedTo = null;
    ...
    (globalThis as BridgeGlobal).__pilotPluginBridge__ = {
      sdkUi: {
  ...
  afterEach(() => {
    ...
    container.remove();
    window.localStorage.clear();
    delete (globalThis as BridgeGlobal).__pilotPluginBridge__;
  });
  ...
  it("refreshes and leaves an archived active space after sidebar archive", async () => {
    hostLocation = {
      pathname: "/PIL/wiki/spaces/engineering",
      search: "",
      hash: "",
    };
  ...
  it("keeps sidebar tree selection scoped to sidebar navigation", () => {
    ...
    expect(navigatedTo).toEqual({
      ...
      options: { state: { pilotWikiSidebarTreePath: "wiki/concepts/sidebar-navigation.md" } },
    });
    ...
    hostLocation = {
      pathname: "/PIL/wiki/page/wiki/entities/pilot.md",
      search: "",
      hash: "",
    };
    act(() => {
...
describe("WikiPage", () => {
  ...
  beforeEach(() => {
    ...
    hostLocation = {
      pathname: "/PIL/wiki/page/wiki/projects/control-plane/index.md",
      search: "",
      hash: "",
    };
    navigatedTo = null;
  ...
  it("renders structured Pilot source refs as text", () => {
    act(() => {
    ...
    expect(container.textContent).toContain("PIL-3416 issue - Distillation kickoff");
