...
const desktopTargets = [
  ...
  { slug: "22-spaces-edit", view: "wiki-sidebar", section: "settings/spaces/team-research", scrollToText: "Pilot ingestion" },
  { slug: "22a-spaces-edit-default", view: "wiki-sidebar", section: "settings/spaces/default", scrollToText: "Pilot ingestion" },
...
for (const target of targets) {
  ...
  const url = `${baseUrl}/PIL/wiki${sectionPath}${search}#${target.view}`;
