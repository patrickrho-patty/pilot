...
const MANAGED_AGENT = {
  ...
  resourceKey: "pilotai.plugin-llm-wiki:agent:wiki-maintainer",
...
const MANAGED_PROJECT = {
  ...
  resourceKey: "pilotai.plugin-llm-wiki:project:llm-wiki",
...
const MANAGED_ROUTINE = {
  ...
  resourceKey: "pilotai.plugin-llm-wiki:routine:nightly-wiki-lint",
  routine: {
    id: "rtn-llmw-night",
...
const MANAGED_ROUTINES = [
  {
    ...
    resourceKey: "pilotai.plugin-llm-wiki:routine:cursor-window-processing",
    routine: {
      id: "rtn-llmw-cursor",
  ...
  MANAGED_ROUTINE,
  {
    ...
    resourceKey: "pilotai.plugin-llm-wiki:routine:index-refresh",
    routine: {
      id: "rtn-llmw-index",
...
const MANAGED_SKILL = {
  ...
  details: {
    ...
    key: "plugin/pilotai-plugin-llm-wiki/wiki-maintainer",
    description: "Use the LLM Wiki plugin tools to maintain a cited local company wiki.",
  },
};
const MANAGED_SKILLS = [
  MANAGED_SKILL,
  { status: "resolved", skillId: "skl-llmw-ingest", resourceKey: "wiki-ingest", details: { name: "Wiki Ingest", key: "plugin/pilotai-plugin-llm-wiki/wiki-ingest", description: null } },
  { status: "resolved", skillId: "skl-llmw-query", resourceKey: "wiki-query", details: { name: "Wiki Query", key: "plugin/pilotai-plugin-llm-wiki/wiki-query", description: null } },
  { status: "resolved", skillId: "skl-llmw-lint", resourceKey: "wiki-lint", details: { name: "Wiki Lint", key: "plugin/pilotai-plugin-llm-wiki/wiki-lint", description: null } },
  { status: "resolved", skillId: "skl-llmw-distill", resourceKey: "pilot-distill", details: { name: "Pilot Distill", key: "plugin/pilotai-plugin-llm-wiki/pilot-distill", description: null } },
  { status: "resolved", skillId: "skl-llmw-index", resourceKey: "index-refresh", details: { name: "Index Refresh", key: "plugin/pilotai-plugin-llm-wiki/index-refresh", description: null } },
];
...
const PAGES = {
  ...
  sources: [
    ...
    { rawPath: "raw/pilot-v1-spec.md", title: "Pilot V1 spec", sourceType: "file", url: null, status: "captured", createdAt: "2026-05-01T18:30:00Z" },
...
A **plugin-managed resource** is a normal Pilot resource (agent, routine, project) that a plugin has seeded with suggested defaults. The plugin marks ownership via a stable \`resourceKey\` so that installs, imports, and upgrades can find the resource even when UUIDs differ.
...
`,
  ...
  sourceRefs: ["raw/karpathy-llm-wiki.md", "raw/pilot-v1-spec.md"],
...
const OPERATIONS = {
  operations: [
    { id: "2944aaaaaaaa", operationType: "ingest", status: "running", hiddenIssueId: "ii-2944", hiddenIssueIdentifier: "PIL-OP-2944", hiddenIssueTitle: "Ingest URL: karpathy/llm-wiki gist", hiddenIssueStatus: "in_progress", projectId: "prj-llmw-7e1a", costCents: 1, warnings: [], affectedPages: [], createdAt: "2026-05-01T20:29:48Z", updatedAt: "2026-05-01T20:29:48Z" },
    { id: "2943bbbbbbbb", operationType: "query", status: "done", hiddenIssueId: "ii-2943", hiddenIssueIdentifier: "PIL-OP-2943", hiddenIssueTitle: "How do plugin-managed routines resolve their default agent…", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 1, warnings: [], affectedPages: [], createdAt: "2026-05-01T20:25:00Z", updatedAt: "2026-05-01T20:26:30Z" },
    { id: "2942cccccccc", operationType: "file-as-page", status: "done", hiddenIssueId: "ii-2942", hiddenIssueIdentifier: "PIL-OP-2942", hiddenIssueTitle: "File answer as concepts/routine-agent-resolution.md", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 0, warnings: [], affectedPages: [{ path: "wiki/concepts/routine-agent-resolution.md" }], createdAt: "2026-05-01T20:25:30Z", updatedAt: "2026-05-01T20:25:35Z" },
    { id: "2941dddddddd", operationType: "query", status: "done", hiddenIssueId: "ii-2941", hiddenIssueIdentifier: "PIL-OP-2941", hiddenIssueTitle: "Compare managed agent reset vs detach…", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 1, warnings: [], affectedPages: [], createdAt: "2026-05-01T20:18:00Z", updatedAt: "2026-05-01T20:18:30Z" },
    { id: "2940eeeeeeee", operationType: "lint", status: "done", hiddenIssueId: "ii-2940", hiddenIssueIdentifier: "PIL-OP-2940", hiddenIssueTitle: "Nightly wiki lint · 17 findings (2 critical)", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 4, warnings: [
    ...
    { id: "2939ffffffff", operationType: "ingest", status: "done", hiddenIssueId: "ii-2939", hiddenIssueIdentifier: "PIL-OP-2939", hiddenIssueTitle: "pilot-v1-spec.md · 3 pages created", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 2, warnings: [], affectedPages: [{ path: "wiki/areas/control-plane.md" }, { path: "wiki/concepts/managed-resources.md" }, { path: "wiki/concepts/origin-kind.md" }], createdAt: "2026-05-01T18:30:00Z", updatedAt: "2026-05-01T18:32:00Z" },
    { id: "2934gggggggg", operationType: "ingest", status: "failed", hiddenIssueId: "ii-2934", hiddenIssueIdentifier: "PIL-OP-2934", hiddenIssueTitle: "Internal wiki dump (PDF) · outbound URL not on allowlist", hiddenIssueStatus: "blocked", projectId: "prj-llmw-7e1a", costCents: 0, warnings: [{ message: "outbound URL not on allowlist" }], affectedPages: [], createdAt: "2026-05-01T16:00:00Z", updatedAt: "2026-05-01T16:00:30Z" },
  ],
};
...
You maintain this wiki through Pilot plugin tools.
...
const DISTILLATION_RUNS = [
  {
    ...
    operationIssueIdentifier: "PIL-OP-3201",
  ...
  },
  {
    ...
    operationIssueIdentifier: "PIL-OP-3204",
  ...
  },
  {
    ...
    operationIssueIdentifier: "PIL-OP-3205",
  ...
  },
  {
    ...
    operationIssueIdentifier: "PIL-OP-3198",
...
const DISTILLATION_PAGE_BINDINGS = [
  {
    ...
    metadata: { sourceRefs: [{ id: "PIL-3416", kind: "issue", title: "Distillation kickoff" }, { id: "PIL-3416#c1", kind: "comment", title: "Comment" }] },
    updatedAt: "2026-05-04T15:02:14Z",
  },
  {
    id: "bind-billing",
...
const DISTILLATION_PROVENANCE = {
  ...
  snapshot: {
    ...
    clipped: false,
    sourceRefs: [
      { id: "PIL-3416", kind: "issue", title: "How should we distill?" },
      { id: "PIL-3416#c1", kind: "comment", title: "Approach: cursors" },
      { id: "PIL-3416#doc:plan", kind: "document", title: "Plan v3" },
    ],
...
function readHostLocation() {
  if (typeof window === "undefined") {
    return { pathname: "/PIL/wiki", search: "", hash: "" };
  }
...
const sdkUi: Record<string, unknown> = {
  ...
  useHostNavigation: () => ({
    ...
    navigate: (to: string) => {
      const href = `/PIL${to.startsWith("/") ? to : `/${to}`}`;
...
(globalThis as { __pilotPluginBridge__?: { sdkUi?: Record<string, unknown> } }).__pilotPluginBridge__ = { sdkUi };
