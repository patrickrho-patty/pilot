...
export function createToolDefinitions(client: PilotApiClient): ToolDefinition[] {
  return [
    makeTool(
      "pilotMe",
      "Get the current authenticated Pilot actor details",
      z.object({}),
    ...
    makeTool(
      "pilotRequestCheckboxConfirmation",
    ...
    makeTool(
      "pilotApiRequest",
      "Make a JSON request to an existing Pilot /api endpoint for unsupported operations",
      apiRequestSchema,
