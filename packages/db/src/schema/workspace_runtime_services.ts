...
import type { RuntimeExposureStatus } from "@pilotai/shared";
...
export const workspaceRuntimeServices = pgTable(
  "workspace_runtime_services",
  {
    ...
    // Structured opt-in `tailscale_https` exposure state (PIL-17049/17050).
    // Null when the service is not configured for HTTPS exposure. Modelled
