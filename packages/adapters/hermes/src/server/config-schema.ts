import type { AdapterConfigSchema } from "@pilotai/adapter-utils";
  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Resume Hermes sessions across Pilot heartbeats.",
      },
      {
        key: "worktreeMode",
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Pass Hermes --quiet for cleaner Pilot run transcripts.",
      },
      {
        key: "verbose",
      ...
      },
      {
        ...
        label: "Pilot API URL",
        type: "text",
        hint: "Optional API base override. Defaults to PILOT_API_URL.",
      },
      {
        key: "promptTemplate",
