  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        hint: "Hermes API_SERVER_KEY, not PILOT_API_KEY. Stored as a Pilot secret reference.",
        meta: { secret: true },
      },
      {
      ...
      },
      {
        ...
        label: "Pilot API URL",
        type: "text",
        hint: "Optional Pilot API URL reachable by the remote Hermes host. This is not a credential.",
      },
      {
        key: "headers",
        label: "Extra headers",
