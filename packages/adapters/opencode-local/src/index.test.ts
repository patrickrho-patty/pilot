...
describe("buildOpenCodeModelProfiles cheap lane", () => {
  ...
  it("uses PILOT_OPENCODE_CHEAP_MODEL when set (no variant, gateway models may not support it)", () => {
  ...
  it("falls back to PILOT_OPENCODE_SMALL_MODEL so one setting covers both budget lanes", () => {
