import type { AdapterEnvironmentCheck } from "@pilotai/adapter-utils";
 ...
 */
export const ADAPTER_TEST_HOST_TARGET_LABEL = "Pilot host";
...
export function logSandboxProbeDiagnostic(
  ...
  console.warn(`[pilot] ${context}`, detail);
}
