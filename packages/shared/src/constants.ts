...
/**
 * Curated Lucide icon set for projects (PIL-68 part 3).
 *
...
export const MANAGED_MODE_SENTINEL_LEGACY = "pilot_managed";
...
export const TOOL_APPLICATION_TYPES = ["mcp_http", "mcp_stdio", "pilot_plugin", "a2a"] as const;
 ...
 * alongside tool-call events (PIL-11284). These are derived from the
