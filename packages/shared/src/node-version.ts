...
export const NODE_VERSION_INSTALL_GUIDE_URL =
  "https://github.com/patty-io/pilot/blob/master/doc/INSTALLING.md#recommended-install";
const NODE_VERSION_WARNING_EMITTED = Symbol.for("@pilotai/node-version-warning-emitted");
...
export function formatNodeVersionWarning(version: string): string | null {
  ...
  return [
    `[pilot] warning: Node.js ${currentVersion} is unsupported. Pilot requires Node.js ${MINIMUM_NODE_VERSION} or newer.`,
