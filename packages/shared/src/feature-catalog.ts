...
export const INSTANCE_FEATURE_CATALOG: Record<InstanceFeatureKey, FeatureCatalogEntry> = {
  ...
  enableBuiltInAgents: {
    ...
    description:
      "Show Pilot-managed built-in agent surfaces, including roster badges, the Built-in agents tab, and setup controls.",
    tier: "managed",
    cloudDefault: false,
    selfHostedDefault: false,
  },
  enableBetaSkills: {
    title: "Beta skills",
    description: "Allow agents to pin beta releases of the Pilot core skill.",
    tier: "preference",
    cloudDefault: false,
    selfHostedDefault: false,
  },
