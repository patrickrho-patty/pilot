 ...
 * the `PILOT_HIDDEN_SETTINGS` environment variable to a comma-separated
...
/** Every key `PILOT_HIDDEN_SETTINGS` accepts. */
...
/** Parse a `PILOT_HIDDEN_SETTINGS`-style comma-separated list. */
