...
export interface InstanceExperimentalSettings {
  ...
  /**
   * Worktree preview instances (`PILOT_IN_WORKTREE=true`) suppress the
...
export const PILOT_CLOUD_MANAGED_BY = "pilot-cloud" as const;
 ...
 * instances (`PILOT_MANAGED_CONFIG` present) `managedKeys` lists every key
