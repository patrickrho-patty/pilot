...
export interface AskUserQuestionsResult {
  ...
  // sibling ask_user_questions that replaced this one (PIL-437).
 ...
 * a write/destructive MCP tool call (PIL-13726 §D1). Its presence flips the feed
 * card into the dedicated tool-approval rendering (PIL-13745). Arguments are
