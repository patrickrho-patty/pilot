 ...
 * UI clients, and the broker wire protocol cannot drift. See PIL-17049 (plan)
 * and PIL-17050 (threat-model verdict).
 */
...
export interface RuntimeExposureConfig {
  ...
  publicPort: "same";
  /** Provision the Pilot Vite HMR companion listener alongside the app. */
  includePilotViteHmr: boolean;
