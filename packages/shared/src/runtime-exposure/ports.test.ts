...
describe("runtime exposure port policy", () => {
  ...
  it("shares the generic Pilot HMR derivation with high-port overflow fallback", () => {
  ...
  it("builds https URLs on the non-standard port", () => {
    expect(buildRuntimeExposureUrl("pilot-dev.tail29c1aa.ts.net", 42010)).toBe(
      "https://pilot-dev.tail29c1aa.ts.net:42010",
    );
    expect(buildRuntimeExposureHealthUrl("pilot-dev.tail29c1aa.ts.net", 42010)).toBe(
      "https://pilot-dev.tail29c1aa.ts.net:42010/api/health",
    );
  });
