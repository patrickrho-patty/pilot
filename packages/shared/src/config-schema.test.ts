...
describe("pilot config schema", () => {
  it("defaults omitted runtime paths to legacy instance-root locations", () => {
    ...
    expect(parsed.database.embeddedPostgresDataDir).toBe("~/.pilot/instances/default/db");
    expect(parsed.database.backup.dir).toBe("~/.pilot/instances/default/data/backups");
    expect(parsed.logging.logDir).toBe("~/.pilot/instances/default/logs");
    expect(parsed.storage.localDisk.baseDir).toBe("~/.pilot/instances/default/data/storage");
    expect(parsed.secrets.localEncrypted.keyFilePath).toBe("~/.pilot/instances/default/secrets/master.key");
  });
