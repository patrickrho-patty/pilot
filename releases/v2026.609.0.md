...
- **Stronger CLI and API parity** - The CLI now sends `X-Pilot-Run-Id` so agents can mutate their own issues via the CLI, plus broader OpenAPI spec coverage, auth metadata, and CLI/API parity tests. ([#7642](https://github.com/paperclipai/paperclip/pull/7642), [#4579](https://github.com/paperclipai/paperclip/pull/4579), [#6626](https://github.com/paperclipai/paperclip/pull/6626), @aronprins)
...
- **Foreign tracker keys no longer link as Pilot issues** - Keys from other trackers in your text are no longer mistakenly turned into Pilot issue links. ([#7511](https://github.com/paperclipai/paperclip/pull/7511), @pmn4)
