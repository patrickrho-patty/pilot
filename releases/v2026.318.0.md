...
- **App version label** — The sidebar now displays the running Pilot version. ([#1096](https://github.com/paperclipai/paperclip/pull/1096), @saishankar404)
...
All migrations are additive (new tables and columns) — no existing data is modified. Standard `pilotai` startup will apply them automatically.
