...
- **AWS ECS Fargate deployment runbook** — End-to-end deployment guide for running Pilot on ECS Fargate. ([#3897](https://github.com/paperclipai/paperclip/pull/3897), @neerazz)
- **Structured agent mentions in pilot skill** — Skill comments now use structured `[@Name](agent://id)` mentions instead of raw `@Name` strings. ([#4103](https://github.com/paperclipai/paperclip/pull/4103), @aronprins)
