 ...
 * `PILOT_ALLOWED_ATTACHMENT_TYPES` environment variable to a
 * comma-separated list of MIME types or wildcard patterns to expand the
 * allowed set for routes that use this allowlist.
 *
 * Examples:
 *   PILOT_ALLOWED_ATTACHMENT_TYPES=image/*,application/pdf
 *   PILOT_ALLOWED_ATTACHMENT_TYPES=image/*,application/pdf,text/*
 *
