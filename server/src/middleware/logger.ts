...
export const logger = isProduction
  ? pino({ level: process.env.PILOT_LOG_LEVEL?.trim() || "info", redact: [...HTTP_LOG_REDACT_PATHS] })
  : pino({ level: process.env.PILOT_LOG_LEVEL?.trim() || "debug", redact: [...HTTP_LOG_REDACT_PATHS] }, pino.transport({
      target: "pino-pretty",
