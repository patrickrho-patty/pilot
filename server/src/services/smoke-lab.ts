...
export const SMOKE_LAB_DEMO_EMAIL = "smoke@pilot.test";
...
export const SMOKE_LAB_OAUTH_CLIENT_ID = "pilot-smoke-lab";
...
const HTTP_APP_KEY = "pilot.smoke-lab.http-fixture";
const STDIO_APP_KEY = "pilot.smoke-lab.stdio-fixture";
const HTTP_CONNECTION_NAME = "Smoke Lab HTTP MCP fixture";
const STDIO_CONNECTION_NAME = "Smoke Lab stdio MCP fixture";
const STDIO_TEMPLATE_KEY = "pilot.smoke-lab.stdio-fixture";
const PROFILE_KEY = "pilot.smoke-lab.profile";
  ...
  return {
    ...
    async installFixtures(companyId: string, actor?: SmokeLabActorInfo) {
      ...
      const httpApp = await ensureApplication({
        ...
        description: "Deterministic loopback HTTP MCP fixture for Pilot smoke scenarios.",
        type: "mcp_http",
      });
      const stdioApp = await ensureApplication({
        ...
        name: "Smoke Lab stdio MCP fixture",
        description: "Deterministic stdio MCP fixture for Pilot smoke scenarios.",
        type: "mcp_stdio",
      });
