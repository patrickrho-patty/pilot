...
import { toolAccessAuditEvents, toolRuntimeSlots } from "@pilotai/db";
import type { DeploymentExposure, DeploymentMode, ToolRuntimeSlotStatus } from "@pilotai/shared";
  ...
  async function getOrCreateSlot(input: {
    ...
    const [created] = await db
      ...
      .values({
        ...
        provider: "pilot",
        providerRef: null,
        commandTemplateKey: input.commandTemplateKey ?? "pilot.local-stdio-fixture",
