...
import { agentWakeupRequests, agents, heartbeatRuns, issues } from "@pilotai/db";
import type { IssueCommentMetadata, IssueCommentPresentation, RunLivenessState } from "@pilotai/shared";
...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "Pilot needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "Pilot could not resolve this issue's missing disposition automatically. The issue is blocked on a recovery owner.";
...
export function buildSuccessfulRunHandoffInstruction(input: {
  ...
  return [
    ...
    "",
    "## What happened",
    "Your last run on this issue ended successfully, but the issue is still `in_progress` and has no valid disposition — Pilot cannot tell whether the work is finished, blocked, or unfinished.",
    ...(report
      ? [
          "",
    ...
    "",
    "## Your options",
    "Choose **exactly one** outcome and perform the matching Pilot action:",
    "",
