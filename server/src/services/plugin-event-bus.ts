/**
 * PluginEventBus — typed in-process event bus for the Pilot plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@pilotai/shared";
import type { PluginEvent, EventFilter } from "@pilotai/plugin-sdk";
