...
import { companySecretBindings } from "@pilotai/db";
import type { EnvSecretRefBinding, SecretProjectionClass, SecretVersionSelector } from "@pilotai/shared";
import { envBindingSecretRefSchema } from "@pilotai/shared";
import {
