 ...
 * `PILOT_MANAGED_CONFIG` (parsed fail-closed at startup — see
...
export const BUNDLED_PLUGIN_CATALOG: readonly BundledPluginCatalogEntry[] = [
  {
    key: "cloudflare",
    pluginKey: "pilot.cloudflare-sandbox-provider",
    relativePath: "sandbox-providers/cloudflare",
  },
  {
    key: "daytona",
    pluginKey: "pilot.daytona-sandbox-provider",
    relativePath: "sandbox-providers/daytona",
  },
  {
    key: "e2b",
    pluginKey: "pilot.e2b-sandbox-provider",
    relativePath: "sandbox-providers/e2b",
  },
  {
    key: "exe-dev",
    pluginKey: "pilot.exe-dev-sandbox-provider",
  ...
  {
    key: "novita",
    pluginKey: "pilot.novita-sandbox-provider",
