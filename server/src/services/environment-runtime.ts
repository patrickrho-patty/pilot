...
import { companySecrets, companySecretVersions, environmentLeases } from "@pilotai/db";
import type {
  Environment,
  EnvironmentLease,
...
import { resolveDeclaredSandboxCapabilities } from "@pilotai/shared";
import type { EffectiveSandboxCapabilities } from "@pilotai/adapter-utils/execution-target";
import type {
  CommandManagedDuplexChannel,
} from "@pilotai/adapter-utils/command-managed-runtime";
import type {
...
import { ensureSshWorkspaceReady } from "@pilotai/adapter-utils/ssh";
import {
