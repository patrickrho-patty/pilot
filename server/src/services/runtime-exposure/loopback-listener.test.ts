...
import { RUNTIME_EXPOSURE_APP_PORT_MIN, deriveViteHmrPort } from "@pilotai/shared";
...
// that produced the PIL-17256 failures. Port 42003 is A40B; 52003 is CB23.
const TCP_HEADER =
...
/** The app port from the PIL-17256 lane, and its `/proc` hex form. */
...
describe.skipIf(process.platform !== "linux")("diagnoseRuntimeListenerBinds against live listeners", () => { // Live bind facts come from /proc/net/tcp{,6}, which only exists on Linux.
