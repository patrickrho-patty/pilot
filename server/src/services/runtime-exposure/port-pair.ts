 ...
 * related loopback ports reserved together (PIL-17049 plan, PIL-17050 verdict
 * requirement #2): the app port and its Pilot Vite HMR companion at a fixed
...
export interface AllocateExposurePortPairInput {
   ...
   * every deploy ("keep existing runtime ports when safe", PIL-17158).
   *
   ...
   * port outside the dedicated range (the Pilot App template's 45439) can
