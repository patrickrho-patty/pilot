 ...
 */
import type { CompanyPortabilityManifest } from "@pilotai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Pilot](https://pilot.test)");
  lines.push("");
