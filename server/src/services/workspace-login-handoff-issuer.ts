/**
 * Issues signed workspace login handoff tickets (PIL-17572).
 *
...
import { authUsers, instanceUserRoles, workspaceRuntimeServices } from "@pilotai/db";
import type { WorkspaceReadiness } from "@pilotai/shared";
import {
