/**
 * Control-plane half of the workspace readiness/handoff contract (PIL-17572).
 *
...
import { authUsers, companyMemberships, type Db } from "@pilotai/db";
import type { WorkspaceReadiness, WorkspaceReadinessProbeResult } from "@pilotai/shared";
import {
 ...
 *
 * The worktree's `.pilot/.env` pointer is authoritative because it is what
