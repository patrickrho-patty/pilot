...
function workspace(
  ...
  return {
    ...
    cwd: "/repo/.pilot/worktrees/PIL-16051",
    branchName: "PIL-16051-workspace-ready-notice",
    worktreePath: "/repo/.pilot/worktrees/PIL-16051",
    warnings: [],
    created: true,
...
describe("workspace-ready comment builders", () => {
  it("uses a compact info notice that is collapsed when the workspace has no warnings", () => {
    ...
    expect(buildWorkspaceReadyPresentation(input)).toEqual({
      kind: "system_notice",
      tone: "info",
      title: "Workspace ready · PIL-16051-workspace-ready-notice",
      density: "compact",
      ...
      sections: [
        {
          ...
          rows: [
            ...
            { type: "key_value", label: "Branch", value: "PIL-16051-workspace-ready-notice" },
            { type: "key_value", label: "CWD", value: "/repo/.pilot/worktrees/PIL-16051" },
          ],
        },
        {
          title: "Services",
  ...
  it("includes a distinct worktree row and preserves the existing markdown body", () => {
    ...
    expect(buildWorkspaceReadyMetadata(input).sections[0]).toEqual({
      ...
      rows: [
        ...
        { type: "key_value", label: "Worktree", value: "/repo/.pilot/worktrees/PIL-16051" },
      ],
    });
    expect(buildWorkspaceReadyComment(input)).toBe([
      ...
      "",
      "- Strategy: `git_worktree`",
      "- Branch: `PIL-16051-workspace-ready-notice`",
      "- CWD: `/repo/runtime`",
      "- Worktree: `/repo/.pilot/worktrees/PIL-16051`",
