 ...
 * ~/.pilot/adapter-plugins.json. This is the source of truth for which
...
function ensureDirs(): string {
  ...
  if (!fs.existsSync(pkgJsonPath)) {
    fs.writeFileSync(pkgJsonPath, JSON.stringify({
      name: "pilot-adapter-plugins",
      version: "0.0.0",
      private: true,
      description: "Managed directory for Pilot external adapter plugins. Do not edit manually.",
    }, null, 2) + "\n");
  }
