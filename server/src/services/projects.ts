...
export function projectService(db: Db) {
  const createProject = async (
    ...
    // `color = null` (neutral gray) unless an explicit color is supplied. See PIL-68.
      ...
      if (existingBinding) {
        ...
        if (existingProject) {
          ...
          return {
            ...
            project: project as import("@pilotai/shared").Project | null,
        ...
        return {
          ...
          project: hydrated as import("@pilotai/shared").Project | null,
          status: "relinked",
        };
      }
