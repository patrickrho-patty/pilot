...
/**
 * Regression coverage for https://github.com/pilotai/pilot/issues/4628.
...
describeEmbeddedPostgres("issue list status query parsing", () => {
  const ctx = useEmbeddedPostgres("pilot-issues-list-query-parsing-", {
