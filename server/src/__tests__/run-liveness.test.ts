...
describe("run liveness classifier", () => {
  ...
  it("treats PIL-2000-style validation output as runnable follow-up, not an external blocker", () => {
    const classification = classifyRunLiveness({
      ...baseInput,
      resultJson: {
        summary: "PIL-1949 remains blocked until PIL-2000 is resolved.",
      },
      issueCommentBodies: [
        [
          "Validation is ready for the next pass.",
          "",
          "- Blocked chain context: PIL-1949 -> PIL-1999 -> PIL-2000",
