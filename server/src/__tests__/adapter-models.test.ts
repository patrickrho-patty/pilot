...
import { models as claudeFallbackModels } from "@pilotai/adapter-claude-local";
import { resetClaudeModelsCacheForTests } from "@pilotai/adapter-claude-local/server";
import { models as codexFallbackModels } from "@pilotai/adapter-codex-local";
import { models as cursorFallbackModels } from "@pilotai/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@pilotai/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@pilotai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.PILOT_OPENCODE_COMMAND = "__pilot_missing_opencode_command__";
  ...
  describe("PILOT_ADAPTER_MODELS declared models", () => {
    afterEach(() => {
