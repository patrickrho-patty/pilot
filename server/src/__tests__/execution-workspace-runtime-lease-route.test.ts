...
// (PIL-17249). This suite is about the durable lease, so availability always resolves.
...
describeEmbeddedPostgres("execution workspace runtime control lease enforcement", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("pilot-runtime-lease-route-");
