...
const ORIGINAL_PILOT_HOME = process.env.PAPERCLIP_HOME;
const ORIGINAL_PILOT_INSTANCE_ID = process.env.PAPERCLIP_INSTANCE_ID;
...
afterEach(() => {
  ...
  if (ORIGINAL_PILOT_HOME === undefined) {
    ...
    process.env.PAPERCLIP_HOME = ORIGINAL_PILOT_HOME;
  }
  if (ORIGINAL_PILOT_INSTANCE_ID === undefined) {
    delete process.env.PAPERCLIP_INSTANCE_ID;
  } else {
    process.env.PAPERCLIP_INSTANCE_ID = ORIGINAL_PILOT_INSTANCE_ID;
  }
});
