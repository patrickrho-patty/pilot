...
function pluginManifest() {
  return {
    id: "pilot.fake-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
describeEmbeddedPostgres("environmentCustomImageService", () => {
  ...
  async function seed() {
    ...
    await db.insert(plugins).values({
      pluginKey: "pilot.fake-sandbox-provider",
      packageName: "pilot-plugin-fake-sandbox",
      version: "0.1.0",
      apiVersion: 1,
      categories: ["automation"],
...
function secretPluginManifest() {
  return {
    id: "pilot.fake-secret-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
function invalidIdentityPluginManifest() {
  return {
    id: "pilot.fake-invalid-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
function prototypeKeyIdentityPluginManifest() {
  return {
    id: "pilot.fake-prototype-key-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
describeEmbeddedPostgres("environmentCustomImageService relink", () => {
  ...
  async function seed(opts?: {
    ...
    await db.insert(plugins).values({
      ...
      packageName: `pilot-plugin-${provider}`,
      version: "0.1.0",
      apiVersion: 1,
      categories: ["automation"],
