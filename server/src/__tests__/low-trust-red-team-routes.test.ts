...
import { ISSUE_CONTINUATION_SUMMARY_DOCUMENT_KEY, LOW_TRUST_REVIEW_PRESET } from "@pilotai/shared";
import {
...
describeEmbeddedPostgres("low-trust red-team HTTP route regression suite", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("pilot-low-trust-red-team-routes-");
