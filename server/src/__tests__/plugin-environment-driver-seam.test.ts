...
import { pluginManifestV1Schema, type PilotPluginManifestV1 } from "@pilotai/shared";
import { pluginCapabilityValidator } from "../services/plugin-capability-validator.js";

const baseManifest: PilotPluginManifestV1 = {
...
const objectReferenceManifest: PilotPluginManifestV1 = {
