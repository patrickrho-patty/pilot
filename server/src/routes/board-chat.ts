...
export function boardChatRoutes(
  ...
  // repo-root `skills/pilot-board/SKILL.md` whether running from
  ...
  function loadBoardSkill(): string {
    ...
    const skillPath = path.resolve(here, "../../../skills/pilot-board/SKILL.md");
    try {
      ...
      return (
        ...
        "company through Pilot. Help them create companies, hire agents, " +
  ...
  router.post("/board/chat/stream", async (req, res) => {
    // Conference Room Chat is an experimental surface (PIL-136/PIL-137): the
