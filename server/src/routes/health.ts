...
import { heartbeatRuns, instanceUserRoles, invites } from "@pilotai/db";
import type { DeploymentExposure, DeploymentMode } from "@pilotai/shared";
...
function getCloudHealthStatus(env: CloudInstanceEnv) {
  ...
  return {
    ...
    managedBy: "pilot-cloud" as const,
...
export function healthRoutes(
  ...
  router.get("/", async (req, res) => {
    ...
    const exposeDevServerDetails =
      exposeFullDetails || hasDevServerStatusToken(req.get("x-pilot-dev-server-status-token"));
