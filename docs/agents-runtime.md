...
- `hermes_local`: starts your local `hermes` CLI through `@pilotai/hermes-pilot-adapter`
- `hermes_gateway`: calls an already-running Hermes API server through `@pilotai/hermes-pilot-adapter/gateway`
