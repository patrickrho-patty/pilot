...
feedback-export-20260331T120000Z/
  ...
  traces/
    PAP-123-e5f6g7h8.json      # Pilot feedback envelope (one per trace)
  full-traces/
    PAP-123-e5f6g7h8/
...
- Default endpoint: when no feedback export backend URL is configured, Pilot falls back to `https://telemetry.paperclip.ing`
