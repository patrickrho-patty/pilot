...
| Hermes | `hermes_local` | Runs the local Hermes CLI through `@paperclipai/hermes-pilot-adapter` |
| Hermes Gateway | `hermes_gateway` | Calls an already-running Hermes API server through `@paperclipai/hermes-pilot-adapter/gateway` |
...
New plugin overrides should target `@paperclipai/hermes-pilot-adapter` and
