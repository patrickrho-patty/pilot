...
Manage companies within your Pilot instance.
...
Company logo uploads use the normal Pilot attachment size limit.
...
| `logoUrl` | string | Optional Pilot asset content path for the stored logo image |
