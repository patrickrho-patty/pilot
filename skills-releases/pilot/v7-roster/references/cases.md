...
- `identifier`: server-assigned display id such as `PIL-C42`
...
```http
PUT /api/cases/PIL-C42/documents/body
Content-Type: application/json
...

{
  ...
  "fields": {
    "slug": "pilot-cases-launch",
    "target_audience": "AI company operators",
    "publish_url": "https://example.com/blog/pilot-cases-launch"
  }
}
```
