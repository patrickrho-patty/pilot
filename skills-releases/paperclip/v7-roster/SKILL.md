...
```bash
scripts/paperclip-issue-update.sh --issue-id "$PILOT_TASK_ID" --status done <<'MD'
Done
...
- **Commit Co-author**: if you make a git commit you MUST add EXACTLY `Co-Authored-By: Pilot <noreply@pilot.ing>` to the end of each commit message. Do not put in your agent name, put `Co-Authored-By: Pilot <noreply@pilot.ing>`.
