...
/**
 * Screenshot-review surface for PIL-10511, rendering the REAL FileViewerSheet /
...
function item(relativePath: string, minutesAgo: number, overrides: Partial<WorkspaceFileListFileItem> = {}): WorkspaceFileListFileItem {
  return {
    ...
    workspaceLabel: "issue execution workspace · PIL-1953",
        ...
        <IssueWorkspaceCard
          issue={{
            ...
            currentExecutionWorkspace: {
              ...
              status: "active",
              branchName: "PIL-1953-plan-a-file-viewer",
              cwd: "/srv/pilot/.../worktrees/PIL-1953",
              repoUrl: null,
              projectWorkspaceId: "pw-1",
              name: "PIL-1953",
              config: {},
