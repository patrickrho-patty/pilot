  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      ...
      <SuccessfulRunHandoffCommentCallout
        text={[
          "Pilot exhausted the bounded successful-run handoff correction for this issue, but it still has no valid issue disposition.",
          "",
          ...
          "",
          "- Source issue: [PIL-3053](/PIL/issues/PIL-3053)",
          "- Source run: [`9cdba892-c7ca-4d93-8604-4843873b127c`](/PIL/agents/agent-codex/runs/9cdba892-c7ca-4d93-8604-4843873b127c)",
          "- Corrective handoff run: [`61fdb79b-8012-4676-ac71-2971830e126a`](/PIL/agents/agent-codex/runs/61fdb79b-8012-4676-ac71-2971830e126a)",
          "- Source assignee: [CodexCoder](/PIL/agents/codexcoder)",
...
const meta = {
  title: "Pilot/Successful Run Handoff",
