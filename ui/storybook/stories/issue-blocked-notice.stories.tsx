...
import type { IssueRelationIssueSummary } from "@pilotai/shared";
...
// Rule C (PIL-13554): when a human comment on a `blocked` issue does not reopen
...
export const TaskChatLiveWorkRows: Story = {
  ...
  render: () => {
    ...
    const liveWork = resolveTaskChatLiveWork([
      blocker({ id: "b1", identifier: "PIL-601", title: "Run the guarded cutover", status: "done" }),
      blocker({
        id: "b2",
        identifier: "PIL-602",
      ...
      blocker({ id: "b3", identifier: "PIL-604", title: "Complete final QA", status: "todo" }),
  ...
  render: () => (
    <Frame label="Blocked · two unresolved blockers — count is summarized">
      <IssueBlockedNotice
        ...
        agentName="CodexCoder"
        blockers={[
          blocker({ id: "b1", identifier: "PIL-501", title: "First dependency", status: "in_progress" }),
          blocker({ id: "b2", identifier: "PIL-502", title: "Second dependency", status: "todo" }),
        ]}
      />
    </Frame>
  ),
  ...
  render: () => (
    <Frame label="In progress · has a blocker edge — no reopen framing">
      <IssueBlockedNotice
        ...
        agentName="CodexCoder"
        blockers={[
          blocker({ id: "b1", identifier: "PIL-800", title: "Dependency", status: "in_progress" }),
        ]}
      />
    </Frame>
  ),
