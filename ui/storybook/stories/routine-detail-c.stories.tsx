...
import { storybookAgents, storybookProjects } from "../fixtures/pilotData";
...
const routineRuns = [
  { id: "run-1", source: "manual", status: "succeeded", triggeredAt: new Date("2026-06-09T11:48:00Z"), failureReason: null, triggerPayload: { customer_name: "Acme", deadline: "Fri" }, trigger: { label: "manual", kind: "manual" }, linkedIssue: { id: "issue-1", identifier: "PIL-99221", title: "Weekly digest for Acme" } },
  { id: "run-2", source: "schedule", status: "failed", triggeredAt: new Date("2026-06-08T14:00:00Z"), failureReason: "Cron timed out after 600s", triggerPayload: { customer_name: "Acme" }, trigger: { label: "schedule", kind: "schedule" }, linkedIssue: { id: "issue-2", identifier: "PIL-99220", title: "Weekly digest for Acme" } },
  { id: "run-3", source: "schedule", status: "succeeded", triggeredAt: new Date("2026-06-07T14:00:00Z"), failureReason: null, triggerPayload: { customer_name: "Globex" }, trigger: { label: "schedule", kind: "schedule" }, linkedIssue: { id: "issue-3", identifier: "PIL-99219", title: "Weekly digest for Globex" } },
] as never;
...
const activity = [
  { id: "act-1", action: "trigger.fired", details: { trigger: "schedule", run: "PIL-99221" }, createdAt: new Date("2026-06-09T14:02:00Z") },
  { id: "act-2", action: "routine.updated", details: { fields: ["instructions", "variables"] }, createdAt: new Date("2026-06-09T13:55:00Z") },
  { id: "act-3", action: "run.completed", details: { issue: "PIL-99220", status: "failed" }, createdAt: new Date("2026-06-08T23:01:00Z") },
] as never;
