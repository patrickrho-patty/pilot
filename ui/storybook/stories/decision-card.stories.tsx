...
const ISSUES: Record<string, DecisionIssueRef> = {
  ...
  "issue-target": { id: "issue-target", identifier: "PIL-456", title: "Stale integration epic", href: "/PIL/issues/PIL-456", status: "backlog" },
  "issue-child-1": { id: "issue-child-1", identifier: "PIL-457", title: "Wire the adapter", href: "/PIL/issues/PIL-457", status: "backlog" },
  "issue-child-2": { id: "issue-child-2", identifier: "PIL-458", title: "Backfill fixtures", href: "/PIL/issues/PIL-458", status: "todo" },
  "issue-new": { id: "issue-new", identifier: "PIL-999", title: "Follow-up: document rollout", href: "/PIL/issues/PIL-999", status: "todo" },
};
...
function mkDecision(overrides: Partial<Decision> = {}): Decision {
  return {
    ...
    title: "Stale epic PIL-456 hasn’t moved in 21 days",
    body: "PIL-456 and its two sub-issues have had no activity for three weeks. Cancel the tree, or keep it and I’ll snooze for another week.",
    options: [
      {
        id: "keep",
        label: "Keep it open",
...
const cancelTreeOption = {
  ...
  description: "Cancel PIL-456 and everything beneath it.",
...
export const PendingWithInput: Story = {
  args: {
    ...shared,
    decision: mkDecision({
      body: "Reassign PIL-456 to whoever should own it. Add a note for the record.",
