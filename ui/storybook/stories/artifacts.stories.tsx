 ...
 *  - the flat grid (PIL-10359)
 *  - the new group-by control, stack cards, and selected stack view (PIL-10440 / PIL-10442)
 *
...
function makeArtifact(overrides: Partial<CompanyArtifact>): CompanyArtifact {
  return {
    ...
    openPath: null,
    downloadPath: null,
    issue: { id: "issue-1", identifier: "PIL-10306", title: "Landing visuals refresh" },
    project: { id: "proj-1", name: "Pilot App" },
    createdByAgent: { id: "agent-1", name: "ClaudeCoder" },
    updatedAt: new Date("2026-06-04T12:00:00Z").toISOString(),
    href: "/issues/PIL-10306#attachment-art",
    ...overrides,
  };
}
...
const ARTIFACTS: CompanyArtifact[] = [
  makeArtifact({
    ...
    issue: { id: "issue-2", identifier: "PIL-10205", title: "Record the launch walkthrough" },
    href: "/issues/PIL-10205#work-product-wp-video",
  }),
  makeArtifact({
    id: "img-hero",
    mediaKind: "image",
  ...
  makeArtifact({
    ...
    issue: { id: "issue-3", identifier: "PIL-10341", title: "Draft the rollout plan" },
    createdByAgent: { id: "agent-2", name: "CodexCoder" },
    href: "/issues/PIL-10341#document-plan",
  }),
  makeArtifact({
    id: "txt-notes",
    mediaKind: "text",
...
// ---------------------------------------------------------------------------
// Grouping mock components (PIL-10442). These mirror the production artifact
...
const TASK_GROUPS: MockGroup[] = [
  {
    id: "task:issue-1",
    groupBy: "task",
    issueIdentifier: "PIL-10306",
    issueTitle: "Landing visuals refresh",
    count: 5,
    preview: makeArtifact({ mediaKind: "image", contentPath: SAMPLE_IMAGE }),
    updatedAt: new Date("2026-06-04T12:00:00Z").toISOString(),
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-1",
  },
  {
    id: "task:issue-2",
    groupBy: "task",
    issueIdentifier: "PIL-10205",
    ...
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-2",
  },
  {
    id: "task:issue-3",
    groupBy: "task",
    issueIdentifier: "PIL-10341",
    ...
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-3",
  },
  {
    id: "task:issue-4",
    groupBy: "task",
    issueIdentifier: "PIL-10412",
    ...
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-4",
  },
  {
    id: "task:issue-5",
    groupBy: "task",
    issueIdentifier: "PIL-10391",
    ...
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-5",
  },
  {
    id: "task:issue-6",
    groupBy: "task",
    issueIdentifier: "PIL-10377",
    ...
    href: "/PIL/artifacts?groupBy=task&groupIssueId=issue-6",
  },
];
...
const PARENT_TASK_GROUPS: MockGroup[] = [
  {
    ...
    groupBy: "parent_task",
    issueIdentifier: "PIL-10300",
    issueTitle: "Launch readiness epic",
    count: 14,
    preview: makeArtifact({ mediaKind: "image", contentPath: SAMPLE_IMAGE }),
    updatedAt: new Date("2026-06-04T12:00:00Z").toISOString(),
    href: "/PIL/artifacts?groupBy=parent_task&groupIssueId=root-1",
  },
  {
    id: "parent_task:root-2",
    groupBy: "parent_task",
    issueIdentifier: "PIL-10200",
    issueTitle: "Marketing site rebuild",
    count: 9,
    preview: makeArtifact({ mediaKind: "image", contentPath: SAMPLE_IMAGE_TEAL }),
    updatedAt: new Date("2026-06-03T14:25:00Z").toISOString(),
    href: "/PIL/artifacts?groupBy=parent_task&groupIssueId=root-2",
  },
  {
    id: "parent_task:root-3",
    groupBy: "parent_task",
    issueIdentifier: "PIL-10180",
    ...
    href: "/PIL/artifacts?groupBy=parent_task&groupIssueId=root-3",
  },
];
      ...
      <div className="mx-auto w-full max-w-6xl space-y-5 p-6">
        ...
        <div className="flex flex-col gap-2 border-b border-border pb-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2 min-w-0">
            <a
              href="/PIL/artifacts?groupBy=task"
            ...
            <span className="shrink-0 font-mono text-[11px] text-muted-foreground">PIL-10306</span>
