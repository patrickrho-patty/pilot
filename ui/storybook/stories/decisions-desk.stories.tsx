...
function interactionRow(
  ...
  return item(id, "issue_thread_interaction", "medium", title, "Confirmation requested on an issue thread.", {
    ...
    subject: {
      ...
      identifier: null,
      status: "pending",
      href: `/PIL/issues/PIL-1000#interaction-${id}`,
      metadata: { kind: "request_confirmation", issueId: "issue-1000" },
    },
    decisionVerbs: [
...
/**
 * Collapsed interaction rows, one per resolver audience (PIL-17287). Each row
