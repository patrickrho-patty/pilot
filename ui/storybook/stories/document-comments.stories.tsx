...
function PanelFrame({
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="pilot-story__label">{label}</div>
      ...
      <main className="pilot-story__inner">
        <section className="pilot-story__frame overflow-hidden">
          <div className="border-b border-border px-5 py-4">
            <div className="pilot-story__label">Document comments · PIL-10960</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Inline document comment panel (PIL-10960): simplified to drop the header, filter chips, and empty-state, surface the author identity in the composer, and clamp quotes to two lines.",
      },
    },
  },
