...
import type { Issue } from "@pilotai/shared";
...
// Mirrors the PIL-1953 topology called out in the PIL-2189 plan:
      ...
      <main className="pilot-story__inner">
        <div className="mx-auto max-w-5xl space-y-5">
          <header className="space-y-1">
            <div className="pilot-story__label">Issue Detail · Sub-issues</div>
            <h1 className="text-2xl font-semibold tracking-tight">
              Workflow-sorted sub-issues with checklist affordances
            </h1>
            <p className="max-w-3xl text-sm text-muted-foreground">
              Fixture mirrors the PIL-1953 topology called out in the PIL-2189
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Review surface for the PIL-2189 checklist-style sub-issues work. Renders the IssuesList component with the Sub-issues panel props so the progress strip, workflow sort, step gutter, current marker, done de-emphasis, and blocker chips are all visible against a PIL-1953-like topology.",
      },
    },
  },
  decorators: [
