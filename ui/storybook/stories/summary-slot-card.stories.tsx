...
// QA fixtures for PIL-13939 — mirror the shapes exercised by
...
// state renders its live status line (PIL-13984).
...
// draft preview (PIL-13986). Learns the run id from a progress event first, then
...
const failedSeed: SeedInput = {
  ...
  slotResponse: {
    slot: slot({
      status: "failed",
      failureReason: "Summary generation task PIL-14000: Summarize project finished without writing a summary.",
...
// PIL-13986 — token-streamed draft rendering.
