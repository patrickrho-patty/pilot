...
import type { Issue, IssueLabel, Project } from "@pilotai/shared";
...
function IssuePropertiesMobileBlockerActionsPane() {
  ...
  return (
    <StorybookData>
      <div ref={rootRef} className="pilot-story min-h-screen p-4">
    ...
    <div className="grid gap-5 lg:grid-cols-2">
      <div className="rounded-lg border border-border bg-background/70 p-4">
        ...
        <IssueLinkQuicklook
          ...
          to={`/PIL/issues/${primaryIssue.identifier}`}
        ...
        <div className="mt-4 rounded-md border border-border bg-popover p-3 shadow-xl">
          <IssueQuicklookCard
            issue={primaryIssue}
            linkTo={`/PIL/issues/${primaryIssue.identifier}`}
            compact
          />
        </div>
      </div>
      ...
      <div className="rounded-lg border border-border bg-background/70 p-4">
        ...
        <div className="mt-4 rounded-md border border-border bg-card p-3">
          <IssueQuicklookCard
            ...
            linkTo={`/PIL/issues/${storybookIssues[2]!.identifier}`}
          />
        </div>
      </div>
    </div>
        ...
        <main className="pilot-story__inner space-y-6">
          <section className="pilot-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="pilot-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="pilot-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="pilot-story">
        <main className="pilot-story__inner space-y-6">
          <section className="pilot-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="pilot-story__label">IssueRunLedger</div>
