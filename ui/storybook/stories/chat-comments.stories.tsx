...
import type { Agent, FeedbackVote, IssueComment } from "@pilotai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/pilotData";
...
function Section({
  ...
  return (
    <section className="pilot-story__frame overflow-hidden">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-border px-5 py-4">
        <div>
          <div className="pilot-story__label">{eyebrow}</div>
...
const markdownComments = [
  createComment({
    ...
    body: [
      ...
      "- Include a link to [the issue guide](/issues/PIL-1676)",
      "",
      "```ts",
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Pilot work: checkout, comments, linked runs, and review feedback.\n\nFlaky CI lives in https://github.com/acme/web/pull/242 — re-running. Plain control link: https://random.example.com/path stays undecorated.",
      ...
      sections: [
        {
          ...
          rows: [
            { type: "issue_link", label: "Source issue", issueId: issueId, identifier: "PIL-3440", title: "Successful run handoff" },
      ...
      sections: [
        {
          title: "Required action",
          rows: [
            { type: "issue_link", label: "Source issue", issueId, identifier: "PIL-3660", title: "Show issue-thread notices" },
            { type: "agent_link", label: "Assignee", agentId: codexAgent.id, name: codexAgent.name },
...
const issueThreadNoticeReviewTimelineEvents: IssueTimelineEvent[] = [
  createSystemEvent({
    ...
    workspaceChange: {
      ...
      to: {
        label: "PIL-3660 issue-thread-notices",
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <ScenarioCard
            ...
            description="Issue is in planning mode. The composer turns amber and surfaces a Planning chip next to the pilot — clicking it stages a Standard submission without immediately changing the issue mode."
          >
            <IssueChatThread
              comments={[]}
              timelineEvents={[]}
...
function IssueThreadNoticeReview() {
  return (
    <div className="pilot-story">
      <main className="pilot-story__inner max-w-4xl">
...
// PIL-15871 — compact recovery notices collapse to a single quiet row and
...
function CompactRecoveryNoticeReview() {
  return (
    <div className="pilot-story">
      <main className="pilot-story__inner max-w-4xl space-y-6">
...
function ChatCommentsStories() {
  return (
    <div className="pilot-story">
      <main className="pilot-story__inner space-y-6">
        <section className="pilot-story__frame p-6">
          <div className="pilot-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Pilot operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="pilot-story">
      <main className="pilot-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
