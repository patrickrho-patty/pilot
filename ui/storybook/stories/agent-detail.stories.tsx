...
import { storybookAgentMap, storybookAgents, storybookIssues } from "../fixtures/pilotData";
 ...
 * (fixed at /PIL/storybook): seed the QueryClient, then navigate to the
...
function AgentDetailScenario() {
  ...
  const target = `/PIL/agents/${AGENT_ROUTE_REF}`;
