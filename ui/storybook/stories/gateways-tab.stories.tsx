...
import type { ToolMcpGatewayWithTokens } from "@pilotai/shared";
    ...
    clientSnippets: [
      {
        ...
        config: {
          mcpServers: {
            "pilot-engineering-inbox": {
              url: "https://pilot.app/api/mcp/gateways/engineering-inbox",
    ...
    clientSnippets: [
      {
        ...
        config: {
          mcpServers: {
            "pilot-support-ops": {
              url: "https://pilot.app/api/mcp/gateways/support-ops",
              headers: { Authorization: "Bearer YOUR_TOKEN" },
            },
          },
        },
...
const meta: Meta = {
  title: "Tools/Gateways (PIL-11182)",
