...
function StoryFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="pilot-story">
      <main className="pilot-story__inner">{children}</main>
    </div>
  );
}
...
export const SystemNoticeTreatment: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Renders the first-class system notice (PIL-3525 plan): warning, danger, and neutral tones in collapsed and expanded states, an in-thread hierarchy comparison against user and agent bubbles, and a before/after replacement of the current nested user-bubble + warning-callout pattern.",
      },
    },
  },
};
