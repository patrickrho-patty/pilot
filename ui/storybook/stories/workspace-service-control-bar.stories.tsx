...
export const LongUrl: Story = {
  ...
  args: {
    services: [
      entry({
        url: "https://pil-14233-execution-workspace-service-start-stop.preview.pilot.test/deeply/nested/path",
      }),
    ],
  },
};
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 truncate text-2xl font-bold text-foreground">
            PIL-14025-skills-need-to-be-organized-in-folders-the-ta…
          </h1>
        </div>
