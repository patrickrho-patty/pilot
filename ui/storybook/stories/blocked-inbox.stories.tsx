...
import type { Issue, IssueBlockedInboxAttention } from "@pilotai/shared";
...
import { storybookIssues } from "../fixtures/pilotData";
...
function attention(
  ...
  return {
    ...
    action: { label: "Resolve PIL-12", detail: null },
    sourceIssue: null,
    leafIssue: null,
    recoveryIssue: null,
    approvalId: null,
...
const fixtureIssues: Issue[] = [
  ...
  },
  {
    ...
    blockedInboxAttention: attention({
      ...
      action: { label: "Resolve PIL-411", detail: null },
    }),
  },
  {
    ...baseIssue,
    ...
    blockedInboxAttention: attention({
      ...
      owner: { type: "agent", agentId: null, userId: null, label: "QA" },
      action: { label: "Resolve PIL-413", detail: null },
    }),
  },
  {
    ...baseIssue,
  ...
  },
  {
    ...
    blockedInboxAttention: attention({
      ...
      action: { label: "Resolve PIL-431", detail: null },
    }),
  },
  {
    ...baseIssue,
