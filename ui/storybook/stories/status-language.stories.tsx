...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@pilotai/shared";
import type {
...
import { createIssue } from "../fixtures/pilotData";
...
const coveredBlockedMatrix: CoveredBlockedCell[] = [
  ...
  },
  {
    ...
    blockerAttention: attention({
      ...
      sampleBlockerIdentifier: "PIL-2175",
    }),
    expectedVisual: "cyan ring",
    expectedCopy: "Blocked · waiting on active sub-issue PIL-2175",
  },
  {
  ...
  },
  {
    ...
    blockerAttention: attention({
      ...
      unresolvedBlockerCount: 1,
      coveredBlockerCount: 1,
      sampleBlockerIdentifier: "PIL-1918",
    }),
    expectedVisual: "cyan ring",
    expectedCopy: "Blocked · covered by active dependency PIL-1918",
  },
  {
  ...
  },
  {
    ...
    blockerAttention: attention({
      ...
      sampleBlockerIdentifier: "PIL-2279",
      sampleStalledBlockerIdentifier: "PIL-2279",
    }),
    expectedVisual: "amber ring with dot",
    expectedCopy: "Blocked · review stalled on PIL-2279",
  },
  {
  ...
  },
  {
    ...
    blockerAttention: attention({
      ...
      unresolvedBlockerCount: 1,
      attentionBlockerCount: 1,
      sampleBlockerIdentifier: "PIL-1042",
    }),
    expectedVisual: "solid red ring",
...
const blockedNoticeFixtures: BlockedNoticeFixture[] = [
  ...
  },
  {
    ...
    blockerAttention: attention({
      ...
      unresolvedBlockerCount: 2,
      stalledBlockerCount: 2,
      sampleStalledBlockerIdentifier: "PIL-2284",
    }),
  },
];
      ...
      <div className="rounded-lg border border-border bg-background text-foreground">
        ...
        <div className={isMobile ? "max-w-[340px]" : "min-w-[620px]"}>
          <IssueRow
            ...
            trailingMeta="waiting on PIL-2175"
          />
        </div>
      </div>
    </div>
    ...
    <div className="pilot-story">
      <main className="pilot-story__inner space-y-6">
        <section className="pilot-story__frame p-6">
          <div className="pilot-story__label">Language</div>
            ...
            <Card className="shadow-none">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <CopyText text="PIL-1641" className="font-mono">PIL-1641</CopyText>
                </div>
                <div className="flex items-center justify-between gap-3">
