...
import {
  ...
  storybookIssues,
  storybookProjects,
} from "../fixtures/pilotData";

const COMPANY_ID = "company-storybook";
const SELECTED_COMPANY_STORAGE_KEY = "pilot.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "pilot:issue-draft";
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .pilot/worktrees/PIL-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/pilot",
    workspacePath: "/Users/dotta/pilot/.pilot/worktrees/PIL-1641-create-super-detailed-storybooks-for-our-project",
    branchName: "PIL-1641-create-super-detailed-storybooks-for-our-project",
    baseRef: "master",
...
const closeReadinessBlocked: ExecutionWorkspaceCloseReadiness = {
  ...
  state: "blocked",
  blockingReasons: [
    "PIL-1670 is still open and references this execution workspace.",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/pilotai/pilot");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/pilot/ui");
  ...
  return (
    ...
    >
      <ExecutionWorkspaceCloseDialog
        ...
        workspaceName={blocked ? "PIL-1670 publish preview worktree" : workspace.name}
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Pilot creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
