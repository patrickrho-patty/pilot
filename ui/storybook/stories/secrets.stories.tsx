...
import { storybookCompanies, storybookSecrets } from "../fixtures/pilotData";
...
if (typeof window !== "undefined") {
  window.localStorage.setItem("pilot.selectedCompanyId", COMPANY_ID);
}
        ...
        <Card className="border-destructive/40 bg-destructive/5">
          <CardHeader className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-muted-foreground">PIL-2350 · run-storybook</span>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-4 space-y-0.5">
                <li>
                  ...
                  <a className="text-primary underline" href="/PIL/company/settings/secrets">
