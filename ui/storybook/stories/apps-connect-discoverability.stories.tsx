...
/**
 * PIL-11091 — discoverability copy for remote MCP URLs.
 *
...
const meta: Meta = {
  title: "Apps/Connect discoverability (PIL-11091)",
...
/**
 * PIL-11092 / PIL-11094 — preview states after "Check config" runs.
 *
