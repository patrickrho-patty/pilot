...
import type { Goal, Project } from "@pilotai/shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="pilot-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="pilot-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("pilot-worktree-enabled", "true");
  setWorktreeMeta("pilot-worktree-name", "PIL-1675-projects-goals-workspaces");
  setWorktreeMeta("pilot-worktree-color", "#0f766e");
  setWorktreeMeta("pilot-worktree-text-color", "#ecfeff");
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {[
          { label: "Branch", value: "PIL-1675-projects-goals-workspaces", icon: GitBranch },
        ...
        <main className="pilot-story__inner space-y-6">
          <section className="pilot-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="pilot-story__label">Projects, goals, and workspaces</div>
