...
import { CONNECTABLE_APP_DEFINITIONS, type AppDefinition } from "@pilotai/shared";
import { queryKeys } from "@/lib/queryKeys";
import { AppsConnect } from "@/pages/apps/AppsConnect";

/**
 * PIL-11283 — the gallery Connect wizard names the connection at create time.
 *
...
const meta: Meta = {
  title: "Apps/Connect name at create time (PIL-11283)",
