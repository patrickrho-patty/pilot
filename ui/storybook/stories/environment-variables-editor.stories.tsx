...
import type { CompanySecret, EnvBinding, SecretStatus } from "@pilotai/shared";
...
const SECRETS: CompanySecret[] = [
  ...
  secret("s-resend-long", "/pilot-cloud/prod/provider/resend/api-key-with-a-very-long-name", { latestVersion: 4 }),
