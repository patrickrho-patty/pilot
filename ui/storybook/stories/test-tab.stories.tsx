...
// ---------------------------------------------------------------------------
// Catalog (12 actions: 7 read, 5 write) — mirrors the PIL-11348 wireframes.
// ---------------------------------------------------------------------------
...
// PIL-11404 — Off side panel polish: audit hint + quarantined variant.
...
export const OffAuditHint: Story = {
  name: "Off — last-changed audit hint (PIL-11404)",
  render: () => (
...
export const QuarantinedAction: Story = {
  name: "New — quarantined action not yet on (PIL-11404)",
  render: () => (
