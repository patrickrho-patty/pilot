...
const briefsAgent: Agent = {
  ...
  metadata: { pilotBuiltInAgent: { key: "briefs", featureKeys: ["briefs"] } },
 ...
 * `titlePriority` giving the name a floor so it never collapses (PIL-12988).
 */
function RosterRow({
  name,
  lifecycle,
  ...
  render: () => (
    <div className="mx-auto max-w-3xl space-y-8 p-6">
      ...
      <div className="space-y-3">
        ...
        >
          Ships with Pilot and powers <strong>Briefs</strong>. Configure it like any agent —
...
// ---------------------------------------------------------------------------
// Reflection Coach bundle status panel (PIL-13099).
// ---------------------------------------------------------------------------
...
const reflectionDefinition = {
  ...
  defaultInstructions: "You are Pilot's built-in Reflection Coach.",
  defaultRole: "general",
