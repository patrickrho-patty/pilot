...
import { CircleDot, Flag, Link2, MoreHorizontal } from "lucide-react";
...
import { storybookAgents, createIssue } from "../fixtures/pilotData";
        ...
        <IssueRow
          issue={createIssue({
            ...
            blockerAttention: {
              ...
              stalledBlockerCount: 0,
              attentionBlockerCount: 1,
              sampleBlockerIdentifier: "PIL-3683",
              sampleStalledBlockerIdentifier: null,
            },
          })}
        />
...
const meta = {
  title: "Pilot/Assigned Backlog Safeguards",
  component: AllStates,
