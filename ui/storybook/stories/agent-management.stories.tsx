...
import { storybookAgents, storybookIssues } from "../fixtures/pilotData";
...
const agentManagementAgents: Agent[] = [
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "pilot-storybook", priority: "normal" }, null, 2),
      env: {
...
const runtimeState: AgentRuntimeState = {
  ...
  sessionParamsJson: {
    issueIdentifier: "PIL-1670",
    workspaceStrategy: "git_worktree",
  },
  stateJson: {
    currentIssue: "PIL-1670",
    workspace: "PIL-1641-create-super-detailed-storybooks-for-our-project",
  },
...
const storybookSecrets: CompanySecret[] = [
    ...
    createdAt: recent(12_000),
	  ...
	  },
	  {
	    ...
	    ownerUserId: null,
	    userSecretDefinitionId: null,
	    key: "/pilot-cloud/prod/database/url",
	    name: "/pilot-cloud/prod/database/url",
	    provider: "local_encrypted",
	    status: "active",
	    managedMode: "pilot_managed",
	    externalRef: null,
        ...
        <main className="pilot-story__inner space-y-6">
          <section className="pilot-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="pilot-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Pilot fixtures.",
      },
    },
  },
...
const managedKubernetesEnvironment: Environment = {
  ...
  envVars: {},
  metadata: { managedByPilot: true, managedKubernetesSandbox: true },
...
function ForcedKubernetesFixtures({
  ...
  // the managed Kubernetes sandbox (PILOT_EXECUTION_MODE=kubernetes).
