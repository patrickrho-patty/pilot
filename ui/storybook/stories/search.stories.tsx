...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/pilotData";
...
function buildIssueResult(overrides: IssueResultOverrides): CompanySearchResult {
  const baseIssue = {
    ...
    identifier: overrides.issue?.identifier ?? "PIL-3142",
  ...
  return {
    ...
    href: `/PIL/issues/${baseIssue.identifier}`,
      ...
      {state === "empty" ? (
        <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
          ...
          <ul className="mt-2 space-y-0.5 text-xs text-muted-foreground">
            ...
            <li>Use an identifier shortcut like <code className="rounded bg-muted px-1 py-0.5">PIL-123</code>.</li>
          </ul>
        </div>
      ) : null}
        ...
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-4 py-10 sm:px-6">
          ...
          <ul className="space-y-1 text-xs text-muted-foreground">
            <li>
              ...
              <code className="rounded bg-muted px-1 py-0.5 text-[11px]">PIL-123</code> to jump straight to an issue.
            </li>
            <li>
...
function SearchStories() {
  return (
    <div className="pilot-story">
      <main className="pilot-story__inner max-w-[1320px] space-y-6">
        <section className="pilot-story__frame p-6">
          <div className="pilot-story__label">Search</div>
        ...
        <section className="pilot-story__frame overflow-hidden">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">/search</div>
        ...
        <section className="pilot-story__frame overflow-hidden">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">/search · screen 3</div>
        ...
        <section className="pilot-story__frame overflow-hidden">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">/search · screen 1</div>
        ...
        <section className="pilot-story__frame overflow-hidden">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">/search · screen 4</div>
        ...
        <section className="pilot-story__frame overflow-hidden p-4">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">Match-source chips</div>
        ...
        <section className="pilot-story__frame overflow-hidden p-4">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">Cmd+K palette</div>
        ...
        <section className="pilot-story__frame overflow-hidden p-4">
          <div className="pilot-story__title-block">
            <div className="pilot-story__label">Search result row</div>
