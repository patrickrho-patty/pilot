...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    ...
    author: "Pilot",
    version: "v2.4.1",
    tagline: "Run and repair local Pilot workspaces.",
    description: "Develop and operate a local Pilot instance.",
  ...
  {
    key: "pilotai/pilot/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "pilotai/pilot/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",
