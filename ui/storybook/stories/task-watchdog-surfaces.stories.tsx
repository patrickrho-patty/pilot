...
import type { Issue, IssueWatchdogSummary } from "@pilotai/shared";
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Surfaces the IssueProperties Watchdog row in empty / configured / triggered-and-linked variants for UX review of the task-watchdog configuration UI (PIL-11294).",
      },
    },
  },
