...
const storybookRepoRoot = "~/pilot";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.pilot/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.pilot/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Pilot product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    companyId: "company-storybook",
    title: "Build Pilot",
    description: "Make Pilot the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @pilotai/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://pilot-docs-preview.vercel.app",
...
export const storybookExecutionWorkspaces: ExecutionWorkspace[] = [
  {
    ...
    name: "PIL-1641 storybook worktree",
    status: "active",
    deliveryState: "unknown",
    cwd: `${storybookWorktreeRoot}/PIL-1641-create-super-detailed-storybooks-for-our-project`,
    repoUrl: "https://github.com/pilotai/pilot",
    baseRef: "master",
  ...
  },
  {
    ...
    mode: "isolated_workspace",
    strategyType: "git_worktree",
    name: "PIL-1608 release smoke cleanup",
    status: "cleanup_failed",
    deliveryState: "unknown",
    cwd: `${storybookWorktreeRoot}/PIL-1608-release-smoke-cleanup`,
    repoUrl: "https://github.com/pilotai/pilot",
    baseRef: "master",
    branchName: "PIL-1608-release-smoke-cleanup",
    providerType: "git_worktree",
    providerRef: null,
    derivedFromExecutionWorkspaceId: null,
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".pilot/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/pilotData.ts`.",
  ].join("\n"),
...
export const storybookEntityNameMap = new Map<string, string>([
  ["issue:issue-storybook-1", "PIL-1641"],
  ["issue:issue-storybook-2", "PIL-1528"],
  ["issue:issue-storybook-3", "PIL-1602"],
  ["issue:issue-storybook-4", "PIL-1668"],
  ["issue:issue-storybook-5", "PIL-1669"],
  ["issue:issue-storybook-6", "PIL-1670"],
  ["issue:issue-storybook-7", "PIL-1591"],
...
export const storybookSecretProviderDiscoveryPreview: SecretProviderConfigDiscoveryPreviewResult = {
  ...
  warnings: ["Skipped 1 Pilot-managed AWS secret from a different deployment namespace."],
  candidates: [
    {
      provider: "aws_secrets_manager",
      displayName: "AWS production",
      ...
      samples: [
        {
          name: "pilot/prod-use1/company-storybook/openai_api_key",
          hasKmsKey: true,
          tagKeys: ["pilot:managed-by", "pilot:environment", "pilot:provider-owner"],
        },
      ],
      signals: {
        namespace: "prod-use1",
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:pilot/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.pilot/instances/default/secrets/key separately from the database."],
    },
    {
