import { legacyIssueThreadInteractionResolverPolicyAlias } from "@pilotai/shared";
 ...
 * (PIL-17277 contract, PIL-17280 surfaces). A fixture that wants a restriction
...
// ---------------------------------------------------------------------------
// MCP tool-approval fixtures (PIL-13745). A `request_confirmation` carrying a
...
// --- P4 governance / lifecycle card states (PIL-15427) ---
...
// --- Explicit resolver restrictions (PIL-17280) ---
...
// --- Per-item verdicts (C3, PIL-13249) ---------------------------------
