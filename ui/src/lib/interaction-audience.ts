 ...
 * (PIL-17280, Phase 3 of the open-default resolver contract in
 ...
 * authorization (see the Phase 1S security verdict on PIL-17278). Everything
 ...
 * metadata the feed ships with the item (PIL-17287). Returns `null` for every
