...
describe("parseWorkspaceFileRef", () => {
  ...
  it("parses trailing-slash directory refs", () => {
    const ref = parseWorkspaceFileRef("content-os/cases/active/2026-06-06-pil-10199-bundled-skills/");
    expect(ref).toEqual({
      path: "content-os/cases/active/2026-06-06-pil-10199-bundled-skills/",
      resourceKind: "directory",
      line: null,
      column: null,
      raw: "content-os/cases/active/2026-06-06-pil-10199-bundled-skills/",
    });
  });
