...
export const PROJECT_ORDER_UPDATED_EVENT = "pilot:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "pilot:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "pilot.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "pilot.projectSortMode";
