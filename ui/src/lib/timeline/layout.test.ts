...
import type { WorkTimelineResult } from "@pilotai/shared";
...
// A trimmed version of the board's locked-design sample (PIL-12422), expressed
...
function sample(): WorkTimelineResult {
  ...
  const spans = [
    span("r1", "agent:ceo", "i-405", "PIL-12405", "09:02", "09:10", "completed"),
    span("r2", "agent:cto", "i-405", "PIL-12405", "09:14", "09:52", "completed"),
    span("r3", "agent:senior", "i-075", "PIL-12075", "09:58", "10:20", "completed"),
    span("r4", "agent:ux", "i-422", "PIL-12422", "10:10", "11:34", "running"),
    span("r5", "agent:codex", "i-423", "PIL-12423", "10:10", "10:56", "completed"),
    span("r6", "agent:codex", "i-075", "PIL-12075", "10:22", "11:08", "completed"), // overlaps r5 → sub-lane
    span("r7", "agent:qa", "i-423", "PIL-12423", "11:40", "12:12", "completed"),
    span("r8", "agent:codex", "i-423", "PIL-12423", "12:20", "12:38", "completed", "r5"), // retry
    span("r9", "system:routine", "i-286", "PIL-12286", "20:00", "20:04", "completed"),
  ];
...
describe("computeLayout", () => {
  ...
  it("does not reuse a board-created assignment edge on later automation runs", () => {
    ...
    data.spans.push({
      ...
      issueId: "i-405",
      issueIdentifier: "PIL-12405",
      issueTitle: "PIL-12405 title",
      start: t("10:30"),
      end: t("10:36"),
      status: "completed",
      retryOfRunId: null,
