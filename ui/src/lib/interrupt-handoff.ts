import { parseAgentMentionHref } from "@pilotai/shared";

/**
 * Shared logic for the "interrupt handoff" UX clarity surfaces (PIL-10669).
 *
...
// --- Standalone assignee picker interrupt (PIL-10675, design surface 2) -------
...
// --- Pause/hold "What this affects" buckets (PIL-10675, design surface 4) ------
