...
describe("buildAgentUpdatePatch", () => {
  ...
  it("preserves pilot skill-sync selections when changing adapter types", () => {
    ...
    agent.adapterConfig = {
      ...agent.adapterConfig,
      pilotSkillSync: { desiredSkills: ["research", "code-review"] },
    };
    ...
    expect((patch.adapterConfig as Record<string, unknown>).pilotSkillSync).toEqual({
