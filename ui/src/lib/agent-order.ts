...
export const AGENT_ORDER_UPDATED_EVENT = "pilot:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "pilot:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "pilot.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "pilot.agentSortMode";
