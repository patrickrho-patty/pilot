import type { IssueAttachment, IssueDocumentSummary, IssueWorkProduct } from "@pilotai/shared";
import { getAttachmentArtifactWorkProductMetadata } from "@pilotai/shared";

/**
 * Selectors for the properties pane's Artifacts tab (PIL-491): which
...
/**
 * Attachment ids owned by valid attachment-backed Pilot work products.
