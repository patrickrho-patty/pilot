...
import { deriveAgentUrlKey, deriveProjectUrlKey, normalizeProjectUrlKey, hasNonAsciiContent } from "@pilotai/shared";
import type { BillingType, FinanceDirection, FinanceEventKind } from "@pilotai/shared";
 ...
 * (PIL-10676). Unlike `sr-only` (which is `position: absolute` and therefore
...
/**
 * Format a project's budget for the projects list view (IA Phase 4 — PIL-60).
