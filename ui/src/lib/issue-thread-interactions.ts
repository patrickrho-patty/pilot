 ...
 * stores in `result.items[].verdict` (see PIL-13247).
 */
 ...
 *    PIL-419 `freeText` flag) AND no selectable fixed option.
 *
 ...
 * creator posted a newer one on the same issue (PIL-437). The replacement card
 ...
 * (PIL-424 / 00b136f45: hiding a pending question would strand the assignee).
