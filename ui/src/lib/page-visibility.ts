...
/**
 * Page-visibility helpers for restore-storm mitigation (PIL-12556 / Phase 1).
 *
 ...
 *
 * The distinction matters because the UX guidance (PIL-12552 §6, "active-tab exemption")
...
/** Stable header value for `X-Pilot-Tab-Visible`: "focused" | "visible" | "hidden". */
