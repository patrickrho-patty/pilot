 ...
 * `caseHref("PIL", "PIL-C5")` → `/PIL/cases/PIL-C5`.
 *
 * Case paths carry identifiers like `PIL-C5` in the first segment, which the
 ...
 * via the PIL-13002 unprefixed→prefixed redirect. This builder emits the
