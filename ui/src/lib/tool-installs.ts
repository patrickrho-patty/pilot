import type { ToolConnectionInstall } from "@pilotai/shared";

/**
 * Shared "Permitted vs Installed" helpers (Phase 3b, PIL-13618).
 *
...
// --- Copy (verbatim from the PIL-13615 wireframe spec) ---
