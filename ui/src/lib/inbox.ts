...
export const DISMISSED_KEY = "pilot:inbox:dismissed";
export const READ_ITEMS_KEY = "pilot:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "pilot:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "pilot:inbox:issue-columns";
export const INBOX_NESTING_KEY = "pilot:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "pilot:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "pilot:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "pilot:inbox:collapsed-groups";
export const INBOX_COLLAPSED_PARENTS_KEY_PREFIX = "pilot:inbox:collapsed-parents";
