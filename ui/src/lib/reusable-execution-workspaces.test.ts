...
describe("buildReusableExecutionWorkspaceOptionGroups", () => {
  ...
  it("builds stable display and search metadata", () => {
    ...
    expect(option.label).toBe("Pilot app");
    expect(option.description).toBe("feature/workspaces");
    expect(option.searchText).toBe("Pilot app active feature/workspaces /repo/pilot workspace-1");
  });
  ...
  it("matches workspace options with fuzzy query tokens", () => {
    ...
    const option = groups[0]!.options[0]!;
    expect(reusableWorkspaceOptionMatches(option, "lot reusable")).toBe(true);
  ...
  it("does not match query letters spread across unrelated workspace text", () => {
    const groups = buildReusableExecutionWorkspaceOptionGroups([
      workspace({
        id: "routine-bodies",
        name: "PIL-11694-editing-routine-bodies-should-have-revision-tracking",
        cwd: "/srv/pilot/home/pilotai/pilot/.pilot/worktrees/PIL-11694-editing-routine-bodies",
        branchName: "PIL-11694-editing-routine-bodies-should-have-revision-tracking",
        status: "active",
        lastUsedAt: "2026-01-10T00:00:00.000Z",
      }),
      workspace({
        id: "mobile-agent-chat",
        name: "PIL-11446-on-mobile-the-agent-chat-shouldn-t-hone-indented",
        cwd: "/srv/pilot/home/pilotai/pilot/.pilot/worktrees/PIL-11446-on-mobile-agent-chat",
        branchName: "PIL-11446-on-mobile-the-agent-chat-shouldnt-hone-indented",
        status: "active",
        lastUsedAt: "2026-01-09T00:00:00.000Z",
      }),
      workspace({
        id: "simultaneous-work",
        name: "PIL-11429-why-are-these-live-simultaneously",
        cwd: "/srv/pilot/home/pilotai/pilot/.pilot/worktrees/PIL-11429-live-simultaneously",
        branchName: "PIL-11429-why-are-these-live-simultaneously",
        status: "active",
        lastUsedAt: "2026-01-08T00:00:00.000Z",
      }),
    ], { now });
