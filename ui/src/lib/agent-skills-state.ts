import type { AgentSkillEntry } from "@pilotai/shared";
 ...
 * autosave re-fires forever (a benign-looking sibling of the PIL-13222 storm).
 */
 ...
 * 422 retry storm (PIL-13222). A failed payload only becomes sendable again once
