...
import type { Agent, AgentInstructionsBundle, AgentInstructionsFileDetail, AgentInstructionsFileSummary } from "@pilotai/shared";
...
function makeBundle(
  ...
  return {
    ...
    companyId: "company-1",
    mode: "managed",
    rootPath: "/pilot/agents/agent-1/instructions",
    managedRootPath: "/pilot/agents/agent-1/instructions",
    entryFile,
    resolvedEntryPath: `/pilot/agents/agent-1/instructions/${entryFile}`,
    editable: true,
    warnings: [],
