...
import { deriveOriginatingActor, INBOX_MINE_ISSUE_STATUS_FILTER } from "@pilotai/shared";
...
import type { Approval, HeartbeatRun, Issue, JoinRequest } from "@pilotai/shared";
import {
...
export function Inbox() {
  ...
  // dropping it (which stranded j/k back at the top — PIL-9679 regression).
  ...
  useEffect(() => {
    ...
    // broke hover→j/k sync — PIL-9679). Drop it only when the row is gone.
