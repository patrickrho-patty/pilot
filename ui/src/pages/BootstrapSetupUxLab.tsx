  ...
  return (
    <div className="mt-6 border-t border-border pt-5">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        {hasActiveInvite
          ? "A bootstrap invite is already active. Check your Pilot startup logs for the first‑admin URL, or run this command on the host to rotate it:"
          : "Run this command on the host that runs Pilot to print a one‑time first‑admin invite URL:"}
      </p>
...
function SignedOutPrivate() {
  return (
    <StateChrome>
      <h1 className="text-xl font-semibold">Finish setting up this Pilot</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        No admin has claimed this instance yet. Sign in or create your Pilot account to become the first
...
function PublicInviteOnly() {
  return (
    <StateChrome>
      <h1 className="text-xl font-semibold">This Pilot is waiting on its first admin</h1>
      <p className="mt-2 text-sm text-muted-foreground">
      ...
      <header className="border-b border-border bg-muted/20">
        <div className="mx-auto max-w-3xl px-6 py-6">
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            ...
            as the UX spec for{" "}
            <a className="underline underline-offset-2" href="/PIL/issues/PIL-10113">
              PIL-10113
            </a>{" "}
            and the implementation reference for{" "}
            <a className="underline underline-offset-2" href="/PIL/issues/PIL-10114">
              PIL-10114
            </a>
