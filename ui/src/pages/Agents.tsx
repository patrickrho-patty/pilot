...
import { AGENT_ROLE_LABELS, type Agent, type Environment, type EnvironmentCapabilities } from "@pilotai/shared";
import {
  isStarred,
...
// lives in the task thread, not an agent run state (PIL-75).
