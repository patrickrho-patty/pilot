...
import type { ToolMcpGatewayTokenCreated, ToolMcpGatewayWithTokens } from "@pilotai/shared";
...
/**
 * "Connect a client" dialog (PIL-11178 design of record). Shows the copy-paste
