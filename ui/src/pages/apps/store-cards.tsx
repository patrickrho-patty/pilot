...
/** Popular gallery keys surfaced first in the Browse store (PIL-13254, door 1). */
...
/**
 * First-class "Connect your own tool" card (PIL-12371, Finding C; PIL-13254).
...
/** Labeled door to the developer control-plane (PIL-12371, Finding A cross-link). */
