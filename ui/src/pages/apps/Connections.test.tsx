...
// flushSync-based helper the sibling apps tests use (PIL-12371 gotcha).
...
describe("Connections table (M1b / PIL-13254 door 2)", () => {
  ...
  // F6 (PIL-13254 §4): the row highlight and the Status pill derive from ONE
