...
import type { CompanyPortabilityImportResult, CompanyPortabilityPreviewResult } from "@pilotai/shared";
...
describe("CompanyImport", () => {
  ...
  it("resumes watching a stored import job on mount", async () => {
    ...
    sessionStorage.setItem(
      "pilot:company-import-job:company-1:acme/starter",
    ...
    expect(sessionStorage.getItem("pilot:company-import-job:company-1:acme/starter")).toBeNull();
  });
