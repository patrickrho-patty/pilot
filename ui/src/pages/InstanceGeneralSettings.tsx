...
import type { PatchInstanceGeneralSettings, BackupRetentionPolicy } from "@pilotai/shared";
import {
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              ...
              Pilot Labs. Votes are always saved locally.
            </p>
            {FEEDBACK_TERMS_URL ? (
              <a
      ...
      <section>
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Sign out of this Pilot instance. You will be redirected to the login page.
            </p>
          </div>
          <Button
            variant="outline"
