...
export const sampleTeam: CatalogTeam = {
  id: "pilotai:bundled:company-defaults:core-exec-team",
  key: "pilotai/bundled/company-defaults/core-exec-team",
  kind: "bundled",
  ...
  packageName: "@pilotai/teams-catalog",
  packageVersion: "0.1.0",
};

export const optionalTeam: CatalogTeam = {
  ...sampleTeam,
  id: "pilotai:optional:software-development:platform-pod",
  key: "pilotai/optional/software-development/platform-pod",
  kind: "optional",
...
export const warnTeam: CatalogTeam = {
  ...sampleTeam,
  id: "pilotai:optional:research:lab-with-local-source",
...
// Server-computed installed-team state (PIL-10256). Drives the `INSTALLED · N`
...
export const onboardingTeams: CatalogTeam[] = [
  ...
  {
    ...sampleTeam,
    id: "pilotai:bundled:company-defaults:growth-pod",
    key: "pilotai/bundled/company-defaults/growth-pod",
    slug: "growth-pod",
    name: "Growth Pod",
    description:
  ...
  {
    ...sampleTeam,
    id: "pilotai:bundled:company-defaults:support-pod",
    key: "pilotai/bundled/company-defaults/support-pod",
    slug: "support-pod",
    name: "Support Pod",
