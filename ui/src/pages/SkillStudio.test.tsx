...
describe("SkillStudio create mode", () => {
  ...
  it("forwards the folderId query param so the new skill is filed there (PIL-14086)", async () => {
...
describe("SkillStudio landing", () => {
  ...
  it("renders recently-visited and recently-updated sections, gating avatars to humans", async () => {
    localStorage.setItem("pilot:recent-studio-skills", JSON.stringify(["visited-1"]));
    mockCompanySkillsApi.list.mockResolvedValue([
      makeListItem({
        id: "visited-1",
        name: "Visited One",
...
describe("SkillStudio editor frontmatter", () => {
  ...
  it("offers an 'Edit a copy' CTA on the read-only banner (PIL-13112)", async () => {
