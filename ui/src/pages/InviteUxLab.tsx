...
import { ArrowRight, Check, Clock3, ExternalLink, FlaskConical, KeyRound, Link2, Loader2, MailPlus, ShieldCheck, UserPlus, Users } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-(--tracking-caps) text-zinc-500">You&apos;ve been invited to join Pilot</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a Pilot account. After that, you'll come right back here to accept the invite for Acme Robotics."
      ...
      <Card className="rounded-(--rad-28) shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current Pilot domain returned by the server.
                </div>
              </div>
            ...
            >
              https://pilot.local/invite/new-token
            </button>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Pilot account first. If you already have one, switch to sign in and continue the invite with the same email."
