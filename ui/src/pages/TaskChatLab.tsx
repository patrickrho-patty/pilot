...
/**
 * Demo binding for the agent-bubble copy · 👍 · 👎 cluster (PIL-413). The live
 ...
 * superseded behavior (PIL-368) is visible in the lab.
 */
...
function useStreamingReplay(
  ...
  return baseItems.map((it, idx) => {
    ...
    // Parent-row interstitial (PIL-361/368): reveal the scripted updates
 ...
 */
/**
 * Agent-bubble background treatments explored for PIL-501 (feedback: the
