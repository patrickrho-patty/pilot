...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@pilotai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Pilot file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Pilot storage.";
