...
import { AGENT_ROLES, type AdapterEnvironmentTestResult, type AgentPermissions } from "@pilotai/shared";
...
import type { EnvBinding } from "@pilotai/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("pilotai/pilot/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Pilot runtime skills are added automatically.
              </p>
            </div>
