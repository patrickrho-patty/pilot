...
/**
 * Regression coverage for the post-wizard Conference Room intro (PIL-134,
 * plan: PIL-133 A+B): a fresh mount shows the three-dot typing bubble for
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "Acme Robotics", issuePrefix: "PIL" },
  }),
}));
...
describe("BoardChat staged typing intro", () => {
  ...
  it("holds the dots while the onboarding wizard overlay is open (PIL-134)", async () => {
  ...
  it("holds the dots while the document is hidden (PIL-134)", async () => {
...
describe("typing-dots CSS animation guard (PIL-54 failure mode)", () => {
  // PIL-54: the .typing-dots CSS block was silently dropped from index.css
