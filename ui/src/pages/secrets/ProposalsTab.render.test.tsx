...
import type { CompanySecretProviderConfig, SecretProposalView } from "@pilotai/shared";
...
function makeSecretProposal(overrides: Partial<SecretProposalView> = {}): SecretProposalView {
  return {
    ...
    originIssue: { id: "issue-1", key: "PIL-14743", title: "UI review surface" },
    originRunId: "run-1",
...
describe("ProposalsTab", () => {
  ...
  it("shows a fingerprint and provenance but never the value", async () => {
    ...
    expect(text).toContain("PIL-14743"); // origin issue
