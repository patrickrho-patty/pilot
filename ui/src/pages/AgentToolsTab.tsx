...
/**
 * Agent detail · Tools tab (PIL-10788, surface 09 of the PIL-10771 v2 spec).
 *
  ...
  return (
    <div className="space-y-4">
      <EnforcementBanner
        ...
        body={
          <>
            This is exactly the tool set Pilot will accept for{" "}
              ...
              {catalogLoading ? (
                ...
                <>
                  <p className="text-(length:--text-micro) text-muted-foreground">
                    Tools the agent could name but Pilot would block:
                  </p>
