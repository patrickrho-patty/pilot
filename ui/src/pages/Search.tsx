...
import type { Agent, IssueLabel, Project } from "@pilotai/shared";
...
export function Search() {
  ...
  // Identifier shortcut: when q matches PIL-123 and the API returns an exact identifier match, redirect to it.
  useEffect(() => {
    if (!data) return;
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-4 py-10 sm:px-6">
        ...
        <ul className="space-y-1 text-xs text-muted-foreground">
          <li>
            ...
            <code className="rounded bg-muted px-1 py-0.5 text-(length:--text-micro)">PIL-123</code> to jump straight to a task.
          </li>
          <li>
    ...
    return (
      <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
        ...
        <ul className="mt-2 space-y-0.5 text-xs text-muted-foreground">
          ...
          <li>
            Use an identifier shortcut like <code className="rounded bg-muted px-1 py-0.5">PIL-123</code>.
          </li>
