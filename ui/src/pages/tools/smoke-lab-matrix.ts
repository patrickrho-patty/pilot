...
/**
 * Pure matrix/health helpers for the Smoke Lab tab (PIL-13347 / S2, plan §D3).
 ...
 * (P1–P7), columns are the PIL-12373 governed lifecycle. Each recorded step
...
/** The PIL-12373 governed lifecycle, in order (plan §3). */
