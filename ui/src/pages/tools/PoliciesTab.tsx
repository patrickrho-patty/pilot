...
import { ChevronDown, Copy, FlaskConical, GripVertical, MoreHorizontal, Pencil, Plus, RotateCcw, Shield, Trash2 } from "lucide-react";
import {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full gap-0 p-0 sm:max-w-xl">
        <SheetHeader className="border-b border-border">
          ...
          <SheetDescription>Pick an agent and an action to see what Pilot would do.</SheetDescription>
        </SheetHeader>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">When you approve an Ask-first request, Pilot can remember the decision.</p>
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                {confirm.kind === "delete-rule"
                  ...
                  : "Pilot will ask again the next time this action needs approval."}
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
