...
/**
 * The Advanced door is mounted under `/apps/advanced` (PIL-10862, plan D8).
...
// M8a/M8b — the prosumer-facing Advanced setup tabs (PIL-10839 wires). The only
// screens where "MCP" vocabulary is permitted (PIL-10827).
...
// `smoke-lab` (PIL-13343 / S2) is experimental — hidden from the sidebar unless
