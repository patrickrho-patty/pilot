...
import type { ConnectToolAppResult, McpJsonImportPreview } from "@pilotai/shared";
...
// The tab uses `useNavigate` from the app router (PIL-11088 draft hand-off),
...
describe("PasteConfigTab — discoverability copy (PIL-11091)", () => {
...
describe("PasteConfigTab — activation handoff (PIL-11092)", () => {
  let container: HTMLDivElement;
        ...
        drafts: [
          {
            ...
            warnings: ["Header Authorization will be stored as a Pilot secret before activation."],
          },
        ],
      },
        ...
        drafts: [
          {
            ...
            credentialFields: [],
            warnings: ["Imported stdio commands stay draft-only unless mapped to an approved Pilot template."],
          },
        ],
      },
