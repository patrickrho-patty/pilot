import type { ToolProfileStatus, ToolProfileSummary, ToolProfileWithDetails } from "@pilotai/shared";

/**
 * Prosumer copy for the access-profile index (PIL-10997, AP1). Reads the
