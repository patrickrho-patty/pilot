...
/**
 * M8b — "Run your own" tab on the Advanced door (PIL-10862, plan D8).
 *
  ...
  return (
    <div className="space-y-6">
      <p className="max-w-2xl text-sm text-muted-foreground">
        For a tool that runs from a command. Pilot runs it in your company's own isolated workspace.
        Administrators only.
      </p>
      ...
      <div className="space-y-5 rounded-lg border border-border bg-card p-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground">
            Pilot will register the command and the keys it needs.
          </span>
        </div>
      </div>
