 ...
 * approved Pilot template), so they get no hand-off here.
 */
...
/**
 * M8a — "Paste a config" tab on the Advanced door (PIL-10862, plan D8).
 *
 ...
 * of the two M8 screens where "MCP" vocabulary is allowed (PIL-10827 vocab map).
 */
        ...
        drafts.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            {drafts.some((d) => draftConnectUrl(d)) ? (
              <p className="text-xs text-muted-foreground">
                Checking a remote app creates a draft connection, stores any header replacements as Pilot secrets,
