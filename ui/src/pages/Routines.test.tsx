...
import type { FolderListResult, Issue, RoutineListItem } from "@pilotai/shared";
...
describe("Routines page", () => {
  ...
  it("shows recent runs through the issues list scoped to routine execution issues", async () => {
    ...
    issuesListMock.mockResolvedValue([
      ...
      createIssue({ id: "issue-2", title: "Routine execution B", identifier: "PIL-1001", issueNumber: 1001 }),
    ]);
