          ...
          <div className="min-w-0 space-y-1">
            ...
            <div className="text-xs text-muted-foreground">
              ...
              <span
                ...
                title={templateRef
                  ? `Provider ${activeTemplate.templateKind} ref ${templateRef} (Pilot template ${activeTemplate.id})`
                  : activeTemplate.id}
              >
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    {environment.driver === "ssh" ? (
                      ...
                      <div className="text-xs text-muted-foreground">Runs on this Pilot host.</div>
                    )}
                  </div>
                  <div className="flex flex-wrap items-center gap-2">
        ...
        <div data-testid="managed-environment-form-page">
          <div className="pb-4">
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              {editingEnvironment.description ?? "Your agent runs on a computer managed by Pilot."}
            </p>
            <p className="mt-1 max-w-3xl text-xs text-muted-foreground">
              This environment is provisioned and maintained for you. You can add environment
              variables for your agents; its name and configuration are managed by Pilot.
            </p>
          </div>
          <div className="py-4">
            <Field
      ...
      (mode === "create" || (editingEnvironment && !isPlatformManagedEnvironment(editingEnvironment))) ? (
        ...
        <div data-testid="environment-form-page">
          <div className="pb-4">
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              Configure a reusable execution target for your agents. Saved changes affect future runs; Pilot may start fresh sessions or sandbox leases after environment config changes.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              {environmentForm.driver === "ssh" ? (
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <Field label="Remote workspace path" hint="Absolute path that Pilot will verify during SSH connection tests.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="text"
                      placeholder="/Users/pilot/workspace"
