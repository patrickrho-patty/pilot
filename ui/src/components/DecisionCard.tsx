...
import { decisionEffectTargetIssueIds, type DecisionEffect, type DecisionOption } from "@pilotai/shared";
import type {
  Decision,
...
/**
 * Presentational card for a single Decisions-v1 decision (PIL-14966 / PIL-14939
