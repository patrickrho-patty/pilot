 ...
 *
 * Takeover routes (PIL-10695) collapse the app `<Sidebar/>` to its 64px rail
 ...
 * leaving the settings nav unreadable (PIL-10700). Wrapping the pane in this
...
export function SidebarNavItem({
  ...
  // when the global app sidebar is collapsed to its rail (PIL-10700).
  ...
  // the expanded state and the icon never moves (PIL-10676).
  return (
    <Tooltip>
