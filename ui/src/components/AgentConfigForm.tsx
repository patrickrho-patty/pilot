...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter, isValidBrowserCode, ADAPTER_AUTH_MISSING_CHECK_CODE } from "@pilotai/shared";
...
// Canonical type lives in @pilotai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@pilotai/adapter-utils";
import type { CreateConfigValues } from "@pilotai/adapter-utils";
...
export function AgentConfigForm(props: AgentConfigFormProps) {
  ...
  // Pending binding proposals targeting this agent (PIL-14731). Board-only route;
