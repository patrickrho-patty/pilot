...
describe("CompanySettingsNav", () => {
  ...
  it("maps company settings routes to the expected shared tab value", () => {
    ...
    expect(getCompanySettingsTab("/PIL/company/settings")).toBe("general");
    ...
    expect(getCompanySettingsTab("/PIL/company/export")).toBe("export");
    expect(getCompanySettingsTab("/company/import")).toBe("import");
    expect(getCompanySettingsTab("/PIL/company/import")).toBe("import");
    expect(getCompanySettingsTab("/company/settings/members")).toBe("members");
    expect(getCompanySettingsTab("/PIL/company/settings/members")).toBe("members");
    expect(getCompanySettingsTab("/company/settings/access")).toBe("members");
    expect(getCompanySettingsTab("/PIL/company/settings/access")).toBe("members");
    expect(getCompanySettingsTab("/company/settings/invites")).toBe("invites");
    expect(getCompanySettingsTab("/PIL/company/settings/secrets")).toBe("secrets");
    expect(getCompanySettingsTab("/company/settings/instance/profile")).toBe("instance-profile");
    expect(getCompanySettingsTab("/PIL/company/settings/instance/general")).toBe("general");
    ...
    expect(getCompanySettingsTab("/PIL/company/settings/instance/access")).toBe("instance-access");
    expect(getCompanySettingsTab("/company/settings/instance/heartbeats")).toBe("instance-heartbeats");
    expect(getCompanySettingsTab("/PIL/company/settings/instance/heartbeats")).toBe("instance-heartbeats");
    expect(getCompanySettingsTab("/company/settings/instance/experimental")).toBe("instance-experimental");
    expect(getCompanySettingsTab("/PIL/company/settings/instance/plugins/example")).toBe("instance-plugins");
  ...
  it("renders the active tab and navigates when a different tab is selected", async () => {
    currentPathname = "/PIL/company/settings/members";
