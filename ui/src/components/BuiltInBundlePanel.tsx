 ...
 * [PIL-13099], ux-spec §3–§8). Renders one row per managed resource
...
function resourceActionCopy(
  ...
  if (resource.stockStatus === "stock_update_available") {
    return {
      ...
      body: `You haven't edited this, so Pilot will replace it with the newer shipped version. Nothing you customized is affected, and your adapter credentials and settings are not touched.`,
      confirmLabel: "Update",
      triggerLabel: "Update",
    };
  }
  if (resource.stockStatus === "operator_modified") {
    return {
      ...
      body: `This replaces your edited version with Pilot's current default. Your edits can't be recovered. Adapter credentials and settings are not touched.`,
  ...
  if (resource.stockStatus === "missing") {
    return {
      ...
      body: `This resource is missing. Pilot will recreate it from the shipped default. Adapter credentials and settings are not touched.`,
...
function driftDetail(resource: BuiltInManagedResourceState): string | undefined {
  switch (resource.stockStatus) {
    ...
    case "stock_update_available":
      return "Pilot shipped a newer default.";
    case "missing":
              ...
              <>
                {onRunRoutine && (
                  <ConfirmActionButton
                    ...
                    body="Pilot will create one routine task now. This does not enable the weekly schedule or turn on background work."
                ...
                {scheduleEnabled
                  ? onDisableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Pilot will stop future scheduled Reflection Coach runs. Manual Run once remains available."
                  ...
                  : onEnableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Pilot will allow Reflection Coach to create routine tasks on the weekly schedule. It can spend tokens when those tasks run."
