...
// which keeps the active/hover highlight symmetric around it (PIL-10676):
...
export function SidebarShell({
  ...
  peeking = false,
  resizable = false,
  storageKey = "pilot.sidebar.width",
  className,
  onPanelMouseEnter,
  onPanelMouseLeave,
  onPanelFocusCapture,
    ...
    <div className={cn("relative h-full shrink-0", className)} style={reservedStyle}>
      <div
        className={cn(
          ...
          // Open/close is instant (PIL-10676): no width transition so the rail and
