...
interface InlineEditorProps {
   ...
   * own affordance opens the editor (the description bubble's pencil, PIL-375).
   */
      ...
      return (
        ...
        >
          {foldable ? (
            <FoldCurtain>
              <MarkdownBody
                className={cn("pilot-edit-in-place-content", className)}
    ...
    return (
      ...
      >
        <MarkdownEditor
          ...
          contentClassName={cn("pilot-edit-in-place-content", className)}
