...
describe("StatusIcon", () => {
  ...
  it("maps covered-blocked → In queue (blue in_queue var, no cyan markers)", () => {
    ...
    expect(html).toContain("Blocked · waiting on active sub-task PIL-9");
  });
    ...
    const html = renderToStaticMarkup(
      <StatusIcon
        ...
        blockerAttention={{
          ...
          sampleBlockerIdentifier: "PIL-3541",
          sampleStalledBlockerIdentifier: null,
        }}
      />,
    );
  ...
  it("surfaces stalled-review blocked copy on the accessible label", () => {
    ...
    expect(html).toContain("Blocked · review stalled on PIL-2279");
  });
...
describe("StatusIcon — glyph size (PIL-243a)", () => {
