        ...
        options: [
          {
            ...
            value: "path-only",
            label: "Pilot app",
            searchText: "/srv/pilot/mobile-checkout",
          },
          {
            key: "all:mobile",
            value: "mobile",
            label: "Mobile agent chat",
            searchText: "/srv/pilot/agent-chat",
          },
        ],
      },
    ];
  ...
  it("filters workspace options, moves with arrows, and selects the workspace id with Enter", async () => {
    ...
    const groups = buildWorkspaceSelectGroups([
      ...
      workspace({
        ...
        name: "Marketing site",
        cwd: "/srv/pilot/home/marketing-site",
    ...
    setInputValue(input!, "lot reusable");
    await flush();
    ...
    expect(selectedOptionKey()).toBe("recent:workspace-pilot");
    keyDown(input!, "ArrowDown");
    await flush();
    expect(selectedOptionKey()).toBe("all:workspace-pilot");
    ...
    expect(onValueChange).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        key: "all:workspace-pilot",
        value: "workspace-pilot",
