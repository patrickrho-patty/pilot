...
describe("useLiveRunTranscripts", () => {
  ...
  it("retains an accumulated buffer through a transient empty poll (PIL-462 B3)", async () => {
  ...
  it("prunes a buffer once a run stays absent past the grace window (PIL-462 B3)", async () => {
    vi.useFakeTimers();
    try {
      const ts = "2026-08-08T00:00:00.000Z";
      const row = JSON.stringify({
