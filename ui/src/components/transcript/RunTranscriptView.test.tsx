...
import { parseAcpxStdoutLine } from "@pilotai/adapter-utils/acpx-engine/ui";
    ...
    const entries: TranscriptEntry[] = [
      {
        kind: "stderr",
        ts: "2026-03-12T00:00:00.000Z",
        text: "[pilot] Skipping saved session resume for task \"PIL-485\" because wake reason is issue_assigned.",
      },
      {
        kind: "assistant",
        ts: "2026-03-12T00:00:01.000Z",
