...
vi.mock("@/lib/router", () => ({
  useLocation: () => ({ pathname: "/PIL/timeline" }),
}));
...
describe("WorkTimelineChart", () => {
  ...
  it("opens task bars in a new company-prefixed window", () => {
    ...
    expect(open).toHaveBeenCalledWith("/PIL/issues/issue-1", "_blank", "noopener,noreferrer");
  });
