...
import type { AgentEnvConfig, EnvBinding, IssueWorkMode } from "@pilotai/shared";
...
import { Maximize2, Minimize2, MoreHorizontal, ChevronRight, ChevronDown, Check, CircleDot, Minus, ArrowUp, ArrowDown, AlertTriangle, Tag, Calendar, FileText, Flag, Loader2, ListTree, X, Eye, ShieldAlert, ShieldCheck, ScanEye } from "lucide-react";
...
const DRAFT_KEY = "pilot:issue-draft";
    ...
    >
      <DialogContent
        ...
        onPointerDownOutside={(event) => {
          ...
          if (target?.closest("[data-radix-popper-content-wrapper], [data-pilot-floating-ui]")) {
            event.preventDefault();
          }
        }}
      >
        ...
        <div className="flex items-center gap-1.5 px-4 py-2 border-t border-border flex-wrap shrink-0">
          ...
          {/* Priority chip — PIL-411: hidden behind SHOW_TASK_PRIORITY_UI. */}
          ...
          <Popover open={moreOpen} onOpenChange={setMoreOpen}>
            ...
            <PopoverContent className="w-44 p-1" align="start" data-testid="new-issue-more-menu">
              {/* PIL-411: mobile priority section hidden behind SHOW_TASK_PRIORITY_UI. */}
              {SHOW_TASK_PRIORITY_UI && (
