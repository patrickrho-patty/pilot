...
import type { Agent, DocumentAnnotationThreadWithComments, IssueDocument } from "@pilotai/shared";
...
// of floating over the viewport (PIL-504).
...
export function IssueDocumentAnnotations({
  ...
  const content = (
    <div
      className={cn(
        "pilot-doc-annotation-host relative",
