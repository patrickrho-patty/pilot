...
import type { Agent, ExecutionWorkspace, Project, RoutineVariable } from "@pilotai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/pilot/project-1",
      effectiveLocalFolder: "/tmp/pilot/project-1",
...
describe("RoutineRunVariablesDialog", () => {
  ...
  it("renders workspaceBranch as a read-only selected workspace value", async () => {
    ...
    issueWorkspaceBranchName = "pil-1634-routine-branch";
    ...
    const hasBranchInput = () =>
      Array.from(document.querySelectorAll("input")).some(
        (input) => input.value === "pil-1634-routine-branch",
      );
    ...
    const branchInput = Array.from(document.querySelectorAll("input"))
      .find((input) => input.value === "pil-1634-routine-branch");
