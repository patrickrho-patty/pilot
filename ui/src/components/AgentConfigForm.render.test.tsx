...
import type { Agent, Environment, UserSecretDefinition } from "@pilotai/shared";
import { getEnvironmentCapabilities } from "@pilotai/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "Pilot" }],
...
describe("AgentConfigForm environment selector", () => {
  ...
  it("labels the platform-managed instance default by name, without the driver key", async () => {
    ...
    expect(selector?.textContent).toContain("Default: Pilot Computer");
    expect(selector?.textContent).toContain("Pilot Computer");
