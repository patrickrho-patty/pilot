...
import { BookOpen, LogOut, Megaphone, type LucideIcon, UserRound, UserRoundPen } from "lucide-react";
import type { DeploymentMode, ServerGitInfo } from "@pilotai/shared";
...
const DOCS_URL = "https://docs.pilot.test/";
const FEEDBACK_URL = "https://pilot.test/feedback";
const SOURCE_REPOSITORY_URL = "https://github.com/pilotai/pilot";
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {sourceSha && sourceFullSha ? (
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Pilot v{version}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              ...
              <MenuAction
                label="Documentation"
                description="Open Pilot docs in a new tab."
                icon={BookOpen}
                href={DOCS_URL}
                external
