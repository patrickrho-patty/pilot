...
import type { AgentPermissions, TrustPreset } from "@pilotai/shared";
  ...
  return (
    <div>
      ...
      <div className="rounded-lg border border-border p-4 space-y-3">
        <Field label="Trust preset" hint="Choose how broadly this agent can read and act on Pilot work objects.">
          <select
