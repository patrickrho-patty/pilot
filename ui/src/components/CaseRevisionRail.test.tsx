  ...
  revisions: [
    {
      ...
      issue: { id: "i1", identifier: "PIL-42", title: "Task", status: "in_progress" },
    },
    {
      id: "r1",
      revisionNumber: 1,
...
describe("CaseRevisionRail", () => {
    ...
    act(() => {
      root.render(
        <QueryClientProvider client={queryClient}>
          <CaseRevisionRail caseIdentifier="PIL-C7" documentKey="body" />
        </QueryClientProvider>,
      );
    });
    await flush();
  ...
  it("renders both revisions and shows the latest body by default", async () => {
    ...
    expect(container.querySelector('a[href="/issues/PIL-42"]')).not.toBeNull();
    act(() => root.unmount());
  });
