...
import { buildAgentMentionHref, type Agent, type AttentionItem, type AttentionSourceKind } from "@pilotai/shared";
...
/**
 * Per-card triage strip (PIL-16032 §4.5 / wireframe screen 3). Exposes the
