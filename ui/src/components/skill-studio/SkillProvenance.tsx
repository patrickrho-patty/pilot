...
import type { CompanySkillDetail } from "@pilotai/shared";
...
/**
 * Lineage chip for forked skills (PIL-13112, plan §3.1): "Forked from
...
/**
 * Persistent source notice for repo-synced (`project_scan`) skills (PIL-13112,
