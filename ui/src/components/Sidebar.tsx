...
export function Sidebar() {
  ...
  // Decisions (attention home) is an experimental surface (PIL-13481): the nav
  ...
  // now the standard product sidebar (PIL-12472). The former experimental
  ...
  // Conference Room Chat flag (PIL-136/PIL-137): the Conference Room nav item
    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        ...
        <SidebarSection label="Company" collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
          ...
          {/* One entry — /audit merged into the rich Activity feed (PIL-16302). */}
