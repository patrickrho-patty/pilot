...
import { ChevronDown, ChevronRight, Download, ExternalLink, FileText, GitBranch, GitCommit, Globe, Package, Server } from "lucide-react";
...
/**
 * Artifacts tab of the properties pane (PIL-491).
 *
