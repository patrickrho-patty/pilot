...
import type { Issue, IssueDocument, IssueThreadInteraction } from "@pilotai/shared";
import { isArtifactReviewDocumentKey } from "@pilotai/shared";
...
interface IssuePropertiesPlansTabProps {
   ...
   * renders its own approval control (PIL-418). */
  inline?: boolean;
}
  ...
  return (
    <div className="space-y-4 py-2">
      {/* Plan approval lives in ONE place — the plan confirmation card in the
          conversation thread (PIL-418). This tab now only shows the plan itself
