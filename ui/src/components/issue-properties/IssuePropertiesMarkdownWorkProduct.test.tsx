...
import type { Issue, IssueAttachment, IssueDocument, IssueWorkProduct } from "@pilotai/shared";
import { artifactReviewDocumentKey } from "@pilotai/shared";
...
const issue = { id: "issue-1", identifier: "PIL-1534", workMode: "standard" } as Issue;
