...
import type { Project, ProjectWorkspace, WorkspaceFileListDirectoryItem, WorkspaceFileListFileItem, WorkspaceFileListItem, WorkspaceFileListResponse } from "@pilotai/shared";
...
function createWorkspace(overrides: Partial<ProjectWorkspace> = {}): ProjectWorkspace {
  return {
    ...
    cwd: "/srv/pilot/home/pilotai/pilot-content",
    repoUrl: null,
    repoRef: null,
    defaultRef: null,
    visibility: "default",
...
describe("WorkspaceFileBrowser", () => {
  ...
  it("groups nested paths into collapsible folder rows instead of repeating full paths", () => {
    useQueryMock.mockReturnValue(
      ok(availableResponse([
        createItem({
          title: "tweet.md",
          relativePath: "videos/90-days-pilot/tweet.md",
          displayPath: "videos/90-days-pilot/tweet.md",
        }),
        createItem({
          title: "90-days-pilot-1x1.mp4",
          relativePath: "videos/90-days-pilot/out/90-days-pilot-1x1.mp4",
          displayPath: "videos/90-days-pilot/out/90-days-pilot-1x1.mp4",
          previewKind: "video",
        }),
      ])),
    );
    ...
    expect(container.textContent).toContain("90-days-pilot");
    expect(container.textContent).toContain("tweet.md");
    expect(container.textContent).toContain("90-days-pilot-1x1.mp4");
    expect(container.textContent).not.toContain("videos/90-days-pilot/tweet.md");
  ...
  it("opens a result from a selected other project workspace", () => {
    const contentItem = createItem({
      relativePath: "content-os/cases/active/2026-06-06-pil-10199-bundled-skills/README.md",
      displayPath: "Pilot Content / content-os/cases/active/2026-06-06-pil-10199-bundled-skills/README.md",
      workspaceLabel: "Pilot Content",
      workspaceKind: "project_workspace",
      workspaceId: "workspace-content",
      projectId: "project-content",
      projectName: "Pilot Content",
    });
    useQueryMock.mockImplementation((options: { queryKey: readonly unknown[] }) => {
    ...
    expect(container.textContent).toContain("Pilot Content / Pilot Content");
    const listCall = useQueryMock.mock.calls.find(([options]) => options.queryKey?.[3] === "list");
    expect(listCall?.[0].queryKey[4]).toMatchObject({
      workspace: "project",
      projectId: "project-content",
    ...
    expect(onOpen).toHaveBeenCalledWith({
      path: "content-os/cases/active/2026-06-06-pil-10199-bundled-skills/README.md",
      workspace: "project",
      projectId: "project-content",
      workspaceId: "workspace-content",
      browseFolderPath: null,
  ...
  it("focuses an initial folder in a selected other project workspace", () => {
    const folderPath = "content-os/cases/active/2026-06-06-pil-10199-bundled-skills/";
    const contentItem = createItem({
      relativePath: `${folderPath}README.md`,
      displayPath: `Pilot Content / ${folderPath}README.md`,
      workspaceLabel: "Pilot Content",
      workspaceKind: "project_workspace",
      workspaceId: "workspace-content",
      projectId: "project-content",
