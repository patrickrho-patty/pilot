...
import type { IssueReviewPolicy, StalledReviewDecisionAction } from "@pilotai/shared";
...
interface StalledReviewActionsProps {
  ...
  /**
   * The issue's `reviewPolicy` (PIL-16506). Only an opt-in constraint is shown;
 ...
 * one with no reviewer, interaction, approval, or monitor path left (PIL-16080
