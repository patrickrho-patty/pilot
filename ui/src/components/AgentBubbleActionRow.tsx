 ...
 * {@link TaskChatBubbleActions} (PIL-413). Single-sourced so both footers keep
 ...
 * the conference room (`BoardChat`) speak the same bubble language (PIL-95 /
 * PIL-105). Each surface supplies its own copy text, timestamp label, optional
