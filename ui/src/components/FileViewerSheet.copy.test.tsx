...
import type { ResolvedWorkspaceResource, WorkspaceFileContent } from "@pilotai/shared";
...
describe("FileViewerSheet copy actions", () => {
  ...
  beforeEach(() => {
    ...
    window.history.pushState({}, "", "/PIL/issues/PIL-10629?file=videos%2F90-days-pilot%2Ftweet.md");
  });
    ...
    flushSync(() => {
      root.render(
        <FileViewerSheet
          issueId="issue-1"
          state={{
            path: "videos/90-days-pilot/tweet.md",
            workspace: "auto",
            line: null,
            column: null,
            projectId: null,
