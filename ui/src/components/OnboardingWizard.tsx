...
import { AGENT_ROLES, AGENT_ROLE_LABELS } from "@pilotai/shared";
...
import { DEFAULT_OPENCODE_LOCAL_MODEL, isValidOpenCodeModelId } from "@pilotai/adapter-opencode-local";
import {
...
import { Building2, Bot, ListTodo, ArrowLeft, ArrowRight, Sparkles, Check, Loader2, ChevronDown, X } from "lucide-react";
...
export const ONBOARDING_STORAGE_KEY = "pilot-onboarding-state";
const DEFAULT_TASK_TITLE = "Pilot onboarding";
const DEFAULT_TASK_DESCRIPTION = `You are the Pilot agent. This is your first task. Your job here is to
...
function OnboardingWizardInner({
  ...
  const {
    ...
    // resolve against the local Pilot host (environmentId = null).
  ...
  function handleClose() {
    ...
    // handing off to the launcher card (PIL-52).
  ...
  async function handleLaunchToDashboard() {
    ...
    try {
      ...
      // clobber the first-task URL. See PIL-404.
