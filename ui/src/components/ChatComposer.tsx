...
/**
 * Shared chat composer (PIL-95a / PIL-96).
 *
 ...
 * `trailingTools` props (wired by PIL-95b). The @project/@task picker layers on
 * through PIL-95f. The conference room adopts this bare: textarea + send (+ attach
...
export interface ChatComposerProps {
  ...
  /**
   * Surface treatment (PIL-128 A / PIL-131).
      ...
      <div className="mt-2 flex items-center gap-2">
        {canAttach ? (
          <>
            ...
            >
              {attaching ? <Loader2 className="h-4 w-4 animate-spin" /> : <FileText className="h-4 w-4" />}
            </button>
          </>
        ) : null}
