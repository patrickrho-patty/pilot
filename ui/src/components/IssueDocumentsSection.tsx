...
import { isSystemIssueDocumentKey } from "@pilotai/shared";
...
const getFoldedDocumentsStorageKey = (issueId: string) => `pilot:issue-document-folds:${issueId}`;
...
export function IssueDocumentsSection({
  ...
  const documentBodyContentClassName = "pilot-edit-in-place-content min-h-(--sz-220px) text-sm leading-7";
