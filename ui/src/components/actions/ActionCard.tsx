...
import type { ToolRiskLevel } from "@pilotai/shared";
...
/**
 * Action approval card (PIL-10787 / PIL-10778, surfaces 11/12/99).
 *
 * The card an agent's run posts into the issue thread when a governed tool
 * call needs human approval. Two hard requirements from the PIL-10400 security
  ...
  return (
    ...
    >
      <CardContent className="space-y-3 p-4">
        ...
        {/* Stale banner (PIL-10400 hardening) */}
        {isStale ? (
          <EnforcementBanner
            tone="warning"
