...
import type { WorkspaceRuntimeService } from "@pilotai/shared";
...
describe("buildWorkspaceServiceControlEntries", () => {
  ...
  it("carries the verified HTTPS URL into the launch entry, and no HTTP fallback while pending", () => {
    // PIL-17158: the workspace/project/issue launch links are rendered from these
    ...
    const httpsUrl = "https://pilot-dev.tail29c1aa.ts.net:42010";
