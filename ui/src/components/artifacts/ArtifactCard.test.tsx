...
function makeArtifact(overrides: Partial<CompanyArtifact> = {}): CompanyArtifact {
  return {
    ...
    issue: { id: "issue-1", identifier: "PIL-10306", title: "Landing visuals" },
    ...
    href: "/issues/PIL-10306#attachment-art-1",
    ...overrides,
  };
}
...
describe("ArtifactCard", () => {
  it("renders an image preview with cover image and links to the issue anchor", () => {
    ...
    expect(markup).toContain('href="/issues/PIL-10306#attachment-art-1"');
  ...
  it("renders only the artifact subject and absolute metadata under the preview", () => {
    const markup = renderToStaticMarkup(
      <ArtifactCard
        artifact={makeArtifact({
          ...
          issue: { id: "issue-2", identifier: "PIL-10370", title: "Make artifact page look like this" },
    ...
    expect(markup).not.toContain(">PIL-10370<");
  });
