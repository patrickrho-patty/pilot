...
export function Layout() {
  ...
  // app nav collapses to its rail throughout the Skills Store section (PIL-10879).
  ...
  // the contextual sidebar in a second pane (PIL-10695). One resolver drives
  ...
  // off the takeover route (PIL-10694).
  ...
  // mouse moves away (PIL-10676). Re-armed on the next genuine pointer-leave.
  ...
  // rail doesn't immediately re-expand under the lingering hover (PIL-10676).
  ...
  // (PIL-10676). Auto-closing here made the sidebar collapse on every page change.
        ...
        <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "h-full flex-1")}>
          ...
          <div className={cn(isMobile ? "block" : "flex flex-1 min-h-0")}>
            <main
              ...
              // (PIL-495): while the auto-hiding mobile nav is on screen, raise
              ...
              className={cn(
                ...
                // when the vertical scrollbar appears or disappears (PIL-10907).
                isMobile
