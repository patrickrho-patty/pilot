...
import type { CompanySecret, UserSecretDefinition } from "@pilotai/shared";
  ...
  function switchSource(next: RowSource) {
    ...
    switch (plan.kind) {
      ...
      case "open-store": {
        ...
        // ⋯ path and the picker's + Create item (PIL-12476/12477/12478).
        ...
        >
          ...
          <PopoverContent
            ...
            onInteractOutside={(event) => {
              ...
              // (PIL-12492). Guarding the interaction here makes the create /
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onSelect={() => {
                  ...
                  // closing race as the picker's + Create item (PIL-12476/12477).
