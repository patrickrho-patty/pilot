...
describe("EntityRow", () => {
  ...
  it("gives the title a min-width floor and lets meta shrink under titlePriority (PIL-12988)", () => {
    const markup = renderToStaticMarkup(
      <EntityRow
        title="Alpha"
        titlePriority
  ...
  it("stacks a secondaryRow on its own line beneath the main row (PIL-12988)", () => {
    const markup = renderToStaticMarkup(
      <EntityRow
        title="Alpha"
        titlePriority
