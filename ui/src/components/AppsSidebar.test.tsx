...
// flushSync-based helper (PIL-12371 gotcha).
...
describe("AppsSidebar", () => {
  ...
  it("renders Apps and Developer sections in one sidebar", async () => {
    ...
    // The Developer boundary caption frames who the door is for (PIL-13241 §5).
    expect(container.textContent).toContain("Advanced setup for developers");
    // "Run your own" / "Paste a config" moved to the Connect-an-app page (PIL-10922);
