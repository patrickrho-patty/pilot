 ...
 * Under the open-default contract (PIL-17280) an absent override *is* the open
    ...
    <div className="min-w-0">
      ...
      <Select value={value} onValueChange={(v) => onChange(v as GovernanceSelectValue)} disabled={disabled}>
        <SelectTrigger
          ...
          // the effect sentence was gone (PIL-17297).
        ...
        >
           ...
           * `Anyone (default)` mid-label — PIL-17293/PIL-17297). Passing children
 ...
 * (PIL-17280, contract in `doc/SPEC-implementation.md` §9.8.1).
 */
