 ...
 * signal ("Running"/"Working"). Two curated pools: Pilot's analog-office
...
/** Pilot / analog-office pool — "Clipping" is the guaranteed brand nod.
 * Board-curated round 2 (PIL-349): dropped Cataloguing / Carbon-copying /
