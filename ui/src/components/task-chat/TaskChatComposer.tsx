...
import type { IssueAttachment, IssueWorkMode } from "@pilotai/shared";
...
export function TaskChatComposer({
  ...
  return (
    <div
      className={cn(
        "pilot-task-chat-composer rounded-xl border border-input bg-card p-(--sz-18px) shadow-(--shadow-extract-7) transition-[border-color,box-shadow] focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/15",
      )}
      onKeyDownCapture={(e) => {
