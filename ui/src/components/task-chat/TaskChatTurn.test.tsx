...
describe("TaskChatTurn", () => {
  ...
  it("keeps the interstitial row outside the expand button's hover target (PIL-376)", () => {
  ...
  it("rides the `leading` slot on the header row, anchored above the fold (PIL-413)", () => {
    flushSync(() => {
      root.render(
        <TaskChatTurn
          item={SETTLED}
