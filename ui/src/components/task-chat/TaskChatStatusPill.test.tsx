...
describe("TaskChatStatusPill whimsy", () => {
  ...
  it("mounts a streaming interstitial as its own row above the status line (PIL-361 amended)", () => {
    const item = liveStatus({
      label: "Responding",
  ...
  it("holds the finished update through the dwell, then slides it away (PIL-376)", () => {
  ...
  it("renders the interstitial text without a leading icon (PIL-376)", () => {
