...
/**
 * Host binding for the description-as-first-bubble (PIL-375): the LIVE issue
...
/** ~12 text-sm lines (20px line-height) — the accepted fold default (PIL-375). */
...
/**
 * The task description as the requester's first chat bubble (PIL-375):
