...
describe("isNestableLiveChild", () => {
  ...
  it("nests only tool and usage rows inside the live parent row (PIL-361)", () => {
...
describe("interstitial self-talk classification (PIL-355)", () => {
...
describe("deriveRunStatusLabel streaming interstitial text (PIL-361)", () => {
...
describe("settledRunChildren (PIL-361)", () => {
...
describe("buildMergedTurnSummary (PIL-362)", () => {
...
describe("coalesceSettledTurns (PIL-362)", () => {
  const runA: TranscriptEntry[] = [
...
describe("assembleThreadItems (PIL-367)", () => {
...
describe("prependIssueBrief (PIL-375)", () => {
