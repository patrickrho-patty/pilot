...
export function buildScenario(id: TaskChatStateId): TaskChatScenario {
  switch (id) {
    ...
    case "thinking":
      // The surviving thinking signal (PIL-361): the live line's "Thinking…"
    ...
    case "responding":
      ...
      // status line (PIL-361, amended): it wraps into the 1lh viewport
    ...
    case "responding-burst":
      ...
      // (PIL-368): the lab replay streams each blank-line-separated segment as
    ...
    case "working":
      // Parent-row live turn (PIL-354): the tool-state line owns the activity;
        ...
        items: [
          ...
          // timestamp line ("2:34 PM · ✓ Worked · 38s · 2 tools").
          {
            ...
            attachedTurn: {
              ...
              kind: "turn",
              settled: true,
              // "Worked · N tools" expands to exactly the tool rows (PIL-361):
