...
/**
 * Tools & Access API client (Phase 6, PIL-10389).
 *
...
/** Admin "run your own" command-template create input (M8b, PIL-10862). */
...
export const toolsApi = {
  ...
  // --- Installs (Phase 3b, PIL-13618): which agents carry this connection's
