import type { DecisionInput, DecisionOption } from "@pilotai/shared";
import { api } from "./client";

/**
 * Decisions v1 (PIL-14939 §4). Standalone decision objects proposed by agents
 ...
 * UI-local rather than in `@pilotai/shared` on purpose — only the option /
