...
describe("executionWorkspacesApi.reconcile", () => {
  ...
  // Regression pin (PIL-1705): the frontend path must match the reviewed, OpenAPI-documented
  // backend contract `POST /execution-workspaces/:id/reconcile-branch` (S4 / PIL-1586). A bare
