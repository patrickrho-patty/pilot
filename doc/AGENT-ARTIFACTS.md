...
```sh
skills/pilot/scripts/pilot-upload-artifact.sh path/to/output.webm \
...
2. Upload it with `skills/pilot/scripts/pilot-upload-artifact.sh`.
...
```sh
skills/pilot/scripts/pilot-upload-artifact.sh render.bin \
  --title "Demo video render" \
