...
Source: harvested from [PIL-2432](/PIL/issues/PIL-2432) and made canonical for
the [PIL-13211](/PIL/issues/PIL-13211) Apps v2 unification program.
...
the connector-validation scope in [PIL-12373](/PIL/issues/PIL-12373) is ready to
...
| --- | --- | --- | --- | --- |
| 0 - Proof complete | Built-in/deep wrapper, app install, Google OAuth | GitHub, Slack, Google Drive/Docs | Proved repo, chat, and document flows. | Foundation accepted in [PIL-2367](/PIL/issues/PIL-2367). |
...
whose tool/resource semantics match Pilot grants: Linear, Notion, Sentry,
