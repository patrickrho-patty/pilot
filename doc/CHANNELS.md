...
| --- | --- | --- | --- | --- |
| `stable` | The recommended release | every week or two | `pilotai@latest` | `ghcr.io/patty-io/pilot:latest` |
| `beta` | Release candidates soaking before stable | when promoted | `pilotai@beta` | `ghcr.io/patty-io/pilot:beta` |
| `nightly` | Yesterday's merges, smoke-tested as a unit | once a night | `pilotai@nightly` | `ghcr.io/patty-io/pilot:nightly` |
| `canary` | Every merge to `master`, as it happens | many times a day | `pilotai@canary` | `ghcr.io/patty-io/pilot:canary` |
...
```bash
docker pull ghcr.io/patty-io/pilot:latest    # stable
docker pull ghcr.io/patty-io/pilot:beta
docker pull ghcr.io/patty-io/pilot:nightly
docker pull ghcr.io/patty-io/pilot:canary
```
