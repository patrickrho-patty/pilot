...
- [PIL-1192](/PIL/issues/PIL-1192)
- [PIL-1191](/PIL/issues/PIL-1191)
- [PIL-1188](/PIL/issues/PIL-1188)
- [PIL-1119](/PIL/issues/PIL-1119)
- [PIL-945](/PIL/issues/PIL-945)
- [PIL-1165](/PIL/issues/PIL-1165)
- [PIL-890](/PIL/issues/PIL-890)
- [PIL-254](/PIL/issues/PIL-254)
- [PIL-138](/PIL/issues/PIL-138)

## 1. Purpose

This note inventories the Pilot issues that point to the same UX class of problem:
...
The immediate trigger is [PIL-1192](/PIL/issues/PIL-1192): the issue detail page now feels very slow.
...
Measured against the current assigned issue (`PIL-1191`) on local dev, the slowest single request was the full company issues list:
...
- [PIL-1192](/PIL/issues/PIL-1192): issue page feels like it loads forever
- [PIL-1188](/PIL/issues/PIL-1188): assignee changes in the issue properties pane were slow and needed optimistic UI
- [PIL-945](/PIL/issues/PIL-945): optimistic comment rendering
- [PIL-1003](/PIL/issues/PIL-1003): optimistic comments had duplicate draft/pending behavior
- [PIL-947](/PIL/issues/PIL-947): follow-up breakage from optimistic comments
- [PIL-254](/PIL/issues/PIL-254): long issue threads become sluggish when adding comments
- [PIL-189](/PIL/issues/PIL-189): comment semantics while an issue has a live run

Pattern: the issue page already has a history of needing both optimistic behavior and bounded thread/loading behavior. `PIL-1192` is the same family, not a new category.

## 3.2 Inbox and list-view siblings

- [PIL-1119](/PIL/issues/PIL-1119): optimistic archive had fade-out then snap-back
- [PIL-1165](/PIL/issues/PIL-1165): issue search slow
- [PIL-890](/PIL/issues/PIL-890): issue search slow, make it very fast
- [PIL-138](/PIL/issues/PIL-138): inbox loading feels stuck
- [PIL-470](/PIL/issues/PIL-470): create-issue save state felt slow and awkward

Pattern: Pilot already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."

## 3.3 Broader app-loading siblings

- [PIL-472](/PIL/issues/PIL-472): dashboard charts load very slowly
- [PIL-797](/PIL/issues/PIL-797): reduce loading states through static generation/caching where possible
- [PIL-799](/PIL/issues/PIL-799): embed company data at build time to eliminate loading states
- [PIL-703](/PIL/issues/PIL-703): faster chat and better visual feedback
...
This should address the same performance family as [PIL-254](/PIL/issues/PIL-254).
...
1. `PIL-1192`: issue-detail skeletons and staged loading
