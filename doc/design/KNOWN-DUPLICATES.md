...
- Chat composers: the shared `ChatComposer` vs `MarkdownEditor`-based task composer — deliberately NOT unified in a prior pass (PIL-101); audit the overlap but flag as "Needs human decision".
