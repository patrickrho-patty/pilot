...
cd /work/checkouts/paperclipai-pilot/pr-432
```
...
- Pilot's embedded PostgreSQL and local storage stay inside the container home volume via `PILOT_HOME=/home/reviewer/.paperclip-review`.
