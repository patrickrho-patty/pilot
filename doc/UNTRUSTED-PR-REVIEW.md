...
This is intentionally separate from the normal Pilot dev image.
...
```sh
review-checkout-pr pilotai/pilot 432
cd /work/checkouts/pilotai-pilot/pr-432
```
...
## Preview the Pilot app from the PR
...
- Pilot's embedded PostgreSQL and local storage stay inside the container home volume via `PILOT_HOME=/home/reviewer/.pilot-review`.
