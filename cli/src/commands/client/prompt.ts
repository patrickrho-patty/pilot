...
import type { Agent, Issue, IssueComment } from "@pilotai/shared";
import { addIssueCommentSchema, createIssueSchema } from "@pilotai/shared";
import {
...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update Pilot work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update Pilot work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update Pilot work for an agent using board auth")
