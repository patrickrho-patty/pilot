...
import { createAgentKeySchema, createBoardApiKeySchema, type Agent } from "@pilotai/shared";
import {
...
export function registerTokenCommands(program: Command): void {
  const token = program.command("token").description("Manage Pilot API tokens");
