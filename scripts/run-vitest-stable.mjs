...
const nonServerProjects = [
  "@pilotai/shared",
  "@pilotai/skills-catalog",
  "@pilotai/db",
  "@pilotai/adapter-utils",
  "@pilotai/adapter-claude-local",
  "@pilotai/adapter-codex-local",
  "@pilotai/adapter-openclaw-gateway",
  "@pilotai/adapter-opencode-local",
  "@pilotai/plugin-sdk",
...
const generalWorkspacesAProjects = ["@pilotai/ui", "pilotai"];
