#!/usr/bin/env node
// Screenshot the C3 per-item verdict card stories (PIL-13249) at both
// viewports and both themes against a served storybook-static (see PIL-13249).
...
const OUT_DIR = process.argv[2] || "screenshots/pil-13249";
