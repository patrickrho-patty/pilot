...
Examples:
  scripts/paperclip-issue-update.sh --issue-id "$PILOT_TASK_ID" --status in_progress <<'MD'
  ...
  scripts/paperclip-issue-update.sh --issue-id "$PILOT_TASK_ID" --status done --dry-run <<'MD'
  Done
